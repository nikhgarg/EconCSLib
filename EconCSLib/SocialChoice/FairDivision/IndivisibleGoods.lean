import EconCSLib.Foundations.Graph.Cycle
...
theorem hasStepEnvyCycle_of_transitiveEnvyCycle
  ...
  obtain ⟨i, hi⟩ := hcycle
  obtain ⟨n, hnpos, hn⟩ :=
    EconCSLib.Foundations.Graph.exists_relatesInSteps_pos_of_transGen hi
  exact ⟨i, n, hnpos, hn⟩
...
theorem hasTransitiveEnvyCycle_of_not_acyclic
  ...
  exact EconCSLib.Foundations.Graph.exists_transGen_self_of_not_wellFounded (α := Agent)
...
/--
Finite version of a bounded-envy theorem.
...
/--
Paper-facing finite statement of a bounded-envy theorem:
