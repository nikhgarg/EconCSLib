...
| Problem 6 opposing-type LP translation | `OpposingTypes.paper_problem6_pairShare_pos`, `OpposingTypes.paper_problem6_normalizedItemUtility_eq_pairShare`, `OpposingTypes.paper_problem6_LPFeasible_iff_le_itemFairness`, `OpposingTypes.paper_problem6_LPOptimalValue_eq_optimalItemFairness` | formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | prove the remaining finite LP closed-form solution structure for `x_j`, `y_j`, and `lambda` |
