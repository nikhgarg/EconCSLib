...
| Problem 6 opposing-type LP translation | `OpposingTypes.paper_problem6_pairShare_pos`, `OpposingTypes.paper_problem6_normalizedItemUtility_eq_pairShare`, `OpposingTypes.paper_problem6_LPFeasible_iff_le_itemFairness`, `OpposingTypes.paper_problem6_LPOptimalValue_eq_of_certificate`, `OpposingTypes.paper_problem6_closedPolicy_feasible`, `OpposingTypes.paper_problem6_closedPolicy_feasible_of_denominatorBounds` | LP translation, optimality-certificate interface, closed-policy feasibility bridge, and denominator-bound reduction formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | prove the paper's denominator bounds for the selected pivot and the LP upper-bound side of `Problem6OptimalityCertificate` |
...
| Appendix D Lemma 6 mirror inverse-gap algebra | `OpposingTypes.paper_lemma6_pairShare_mirror_inverse_gap_eq`, `OpposingTypes.paper_lemma6_pairShare_mirror_inverse_gap_nonneg` | scalar mirror-pair algebra formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | lift the inverse-gap inequality through the full user-utility summation comparison |
| Appendix D Lemma 10 midpoint mirror-share setup | `OpposingTypes.paper_lemma10_pairShare_half_add_reverse_eq_one`, `OpposingTypes.paper_lemma10_pairShare_half_eq_one_sub_reverse` | midpoint complementarity algebra formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | formalize the candidate midpoint pivot construction and feasibility comparison |
