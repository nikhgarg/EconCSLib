...
| Problem 6 opposing-type LP translation | `OpposingTypes.paper_problem6_pairShare_pos`, `OpposingTypes.paper_problem6_normalizedItemUtility_eq_pairShare`, `OpposingTypes.paper_problem6_LPFeasible_iff_le_itemFairness`, `OpposingTypes.paper_problem6_typeZero_sum_eq_one`, `OpposingTypes.paper_problem6_LPOptimalValue_eq_of_certificate` | LP translation and optimality-certificate interface formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | instantiate `Problem6OptimalityCertificate` with the paper's closed-form `x_j`, `y_j`, and `lambda` |
| Appendix D Lemma 5 Problem 6 closed form | `OpposingTypes.paper_lemma5_problem6_closed_value`, `OpposingTypes.paper_lemma5_problem6_closed_value_pos`, `OpposingTypes.paper_lemma5_problem6_closed_item_eq`, `OpposingTypes.paper_lemma5_problem6_closed_sparseEqualized`, `OpposingTypes.paper_lemma5_problem6_x_before_pivot`, `OpposingTypes.paper_lemma5_problem6_y_after_pivot` | closed-form value positivity, row sums, item equalization, and conditional coordinate algebra formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | prove pivot-coordinate nonnegativity conditions, construct a `TypePolicy` from the closed forms, and prove Lemma 4 sparse/unique optimality |
