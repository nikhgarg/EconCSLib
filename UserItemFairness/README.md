...
| Sparse-support characterization | `ReducedSparseOptimalityTarget`, `TypePolicy.paper_sparse_shared_items_of_active_pairs_bound_of_maximal_optimum`, `TypePolicy.paper_sparse_shape_of_active_pairs_bound_of_maximal_optimum` | partial bridge formalized | `UserItemFairness/LPReduction.lean`, `UserItemFairness/Symmetry.lean`, `UserItemFairness/MainTheorems.lean` | basic-feasible-solution / LP extreme-point proof for the active-pair bound |
