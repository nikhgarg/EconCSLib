...
| Problem 6 opposing-type LP translation | `OpposingTypes.paper_problem6_pairShare_pos`, `OpposingTypes.paper_problem6_normalizedItemUtility_eq_pairShare`, `OpposingTypes.paper_problem6_LPFeasible_iff_le_itemFairness`, `OpposingTypes.paper_problem6_typeZero_sum_eq_one`, `OpposingTypes.paper_problem6_LPOptimalValue_eq_of_certificate`, `OpposingTypes.paper_problem6_closedPolicy_feasible` | LP translation, optimality-certificate interface, and closed-policy feasibility bridge formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | prove the paper's pivot-coordinate nonnegativity condition and the LP upper-bound side of `Problem6OptimalityCertificate` |
