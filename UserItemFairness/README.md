...
| Problem 6 opposing-type LP item expansion | `OpposingTypes.paper_problem6_pairShare_pos`, `OpposingTypes.paper_problem6_pairShare_lt_one`, `OpposingTypes.paper_problem6_twoType_itemNormalizer_eq`, `OpposingTypes.paper_problem6_normalizedItemUtility_eq_pairShare` | formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | prove the remaining finite LP solution structure for `x_j`, `y_j`, and `lambda` |
