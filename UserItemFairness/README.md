...
| Appendix D Lemma 5 Problem 6 closed form | `OpposingTypes.paper_lemma5_problem6_closed_value`, `OpposingTypes.paper_lemma5_problem6_closed_value_pos`, `OpposingTypes.paper_lemma5_problem6_x_before_pivot`, `OpposingTypes.paper_lemma5_problem6_x_at_pivot`, `OpposingTypes.paper_lemma5_problem6_y_at_pivot`, `OpposingTypes.paper_lemma5_problem6_y_after_pivot` | closed-form value positivity and policy-coordinate algebra formalized conditional on `Problem6SparseEqualized` | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | prove Lemma 4 sparse/unique optimality and instantiate `Problem6SparseEqualized` from the optimal Problem 6 LP solution |
