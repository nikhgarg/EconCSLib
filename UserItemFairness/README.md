...
| Sparse-support characterization | `ReducedSparseOptimalityTarget`, `TypePolicy.paper_sparse_shared_items_of_active_pairs_bound_of_positive_item_fairness`, `TypePolicy.paper_sparse_shape_of_active_pairs_bound_of_positive_item_fairness` | partial bridge formalized | `UserItemFairness/LPReduction.lean`, `UserItemFairness/Symmetry.lean`, `UserItemFairness/MainTheorems.lean` | basic-feasible-solution / LP extreme-point proof for the active-pair bound; positivity of reduced optimal item fairness where the paper invokes optimality |
