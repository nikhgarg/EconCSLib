...
| Appendix D Lemma 9 / Appendix E Lemma 16 `q_j` algebra | `OpposingTypes.paper_lemma9_typeOneShare_strictly_increases_in_alpha`, `OpposingTypes.paper_lemma9_pairShare_strictly_increases_in_alpha`, `OpposingTypes.paper_lemma16_half_lt_pairShare_half_of_val_lt_reverse`, `OpposingTypes.paper_lemma16_pairShare_half_lt_half_of_reverse_val_lt`, `OpposingTypes.paper_lemma16_pairShare_half_eq_half_of_val_eq_reverse`, `OpposingTypes.paper_lemma16_val_lt_reverseItem_iff` | scalar, indexed order, and midpoint arithmetic components formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | none for the scalar/indexed `q_j` comparisons; remaining Theorem 3/4 work is the LP solution structure |
