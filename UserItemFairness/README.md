...
| Appendix D Lemma 9 / Appendix E Lemma 16 `q_j` algebra | `OpposingTypes.paper_lemma9_typeOneShare_strictly_increases_in_alpha`, `OpposingTypes.paper_lemma9_pairShare_strictly_increases_in_alpha`, `OpposingTypes.paper_lemma16_half_lt_pairShare_half_of_reverse_lt`, `OpposingTypes.paper_lemma16_pairShare_half_lt_half_of_lt_reverse`, `OpposingTypes.paper_lemma16_pairShare_half_eq_half_of_eq_reverse` | scalar and indexed components formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | connect indexed value-order assumptions `j < (n+1)/2`, `j > (n+1)/2`, `j = (n+1)/2` to reverse-item value comparisons |
