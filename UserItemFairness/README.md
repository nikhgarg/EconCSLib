...
| Appendix D Lemma 9 / Appendix E Lemma 16 scalar `q_j` algebra | `OpposingTypes.paper_lemma9_typeOneShare_strictly_increases_in_alpha`, `OpposingTypes.paper_lemma16_half_lt_typeOneShare_half_of_right_lt_left`, `OpposingTypes.paper_lemma16_typeOneShare_half_lt_half_of_left_lt_right`, `OpposingTypes.paper_lemma16_typeOneShare_half_eq_half_of_eq` | scalar components formalized | `UserItemFairness/OpposingTypes.lean`, `UserItemFairness/MainTheorems.lean` | lift from scalar item-pair comparisons to indexed opposite-preference vectors |
