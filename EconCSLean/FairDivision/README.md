...
- `EconCSLean/FairDivision/MainTheorems.lean`
...
|---|---|---|---|---|
| Monotone valuation, allocation, envy, and bounded envy definitions | `Valuation`, `IsAllocationOf`, `envy`, `EnvyBoundedBy` | formalized | `EconCSLean/FairDivision/IndivisibleGoods.lean` | none |
| Acyclic envy graph gives an unenvied agent | `exists_noOneEnvies_of_acyclicEnvyGraph` | formalized | `EconCSLean/FairDivision/IndivisibleGoods.lean` | nonempty agent type |
| Finite envy-cycle extraction | `hasEnvyCycleListExtraction_of_finite` | formalized | `EconCSLean/FairDivision/IndivisibleGoods.lean` | none |
| Theorem 2.1, abstract marginal-bound form | `paper_lmms_theorem_2_1_marginal_bound` | formalized | `EconCSLean/FairDivision/MainTheorems.lean` | finite agents/items and marginal bound |
| Theorem 2.1, maximum-marginal form | `paper_lmms_theorem_2_1_max_marginal` | formalized | `EconCSLean/FairDivision/MainTheorems.lean` | finite nonempty agents/items |
