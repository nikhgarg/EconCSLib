...
6. Section 7 now has the finite Yao/minimax expectation lemma, the uniform
   ...
   revenue-bound expression, the logarithmic tail-spend proof, the finite
   layer-count estimate, and the eventual harmonic-cap theorem
   ...
   work is to instantiate `BMatchingTheorem9SymmetricPointwiseFamilyCertificate`
   by proving the online-information symmetry field for the modeled
