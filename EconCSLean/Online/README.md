...
6. Section 7 now has the finite Yao/minimax expectation lemma, the uniform
   ...
   work is to prove the expected round-allocation inequality for deterministic
