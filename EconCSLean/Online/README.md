...
| Theorem 9 randomized b-matching lower bound | `theorem9BidderSpendUpperBound`, `theorem9BidderHarmonicPrefixNat`, `theorem9BidderSpendUpperBound_le_log_tail`, `theorem9NormalizedRevenueUpperBound`, `theorem9HarmonicLayerCountBound_of_pos`, `theorem9NormalizedRevenueUpperBound_le_msvvRatio_add_gridErrors`, `theorem9_harmonic_eventually_le_msvvRatio_add`, `theorem9_eventually_no_randomized_algorithm_beats_msvvRatio_add_delta`, `uniformPermutationExpectation_eq_of_relabel`, `BMatchingYaoLowerBoundCertificate`, `BMatchingPermutationLowerBoundCertificate`, `BMatchingRoundAllocationRevenueCertificate`, `BMatchingPointwiseAllocationRevenueCertificate`, `BMatchingSymmetricPointwiseAllocationRevenueCertificate`, `BMatchingRelabelSymmetricPointwiseAllocationRevenueCertificate`, `BMatchingTheorem9FamilyCertificate`, `BMatchingTheorem9PointwiseFamilyCertificate`, `BMatchingTheorem9SymmetricPointwiseFamilyCertificate`, `BMatchingTheorem9RelabelSymmetricPointwiseFamilyCertificate`, `paper_adwords_theorem9_bidder_spend_upper_bound_le_log_tail`, `paper_adwords_theorem9_harmonic_layer_count_bound`, `paper_adwords_theorem9_harmonic_eventually_le_msvv_ratio_add_delta`, `paper_adwords_theorem9_eventually_no_randomized_algorithm_beats_msvv_ratio_add_delta`, `paper_adwords_theorem9_eventually_no_randomized_algorithm_beats_msvv_ratio_add_delta_of_relabel_symmetric_pointwise_family_certificate` | harmonic cap and relabel-symmetry conditional family endpoint formalized | `EconCSLean/Online/AdWordsLowerBound.lean`, `EconCSLean/Online/MainTheorems.lean` | instantiate the relabel-symmetric pointwise family certificate by proving the online-information pointwise relabel identity for the modeled deterministic algorithms |
...
6. Section 7 now has the finite Yao/minimax expectation lemma, the uniform
   ...
   theorem, the paper's explicit finite harmonic revenue-bound expression, the
   logarithmic tail-spend proof, the finite layer-count estimate, and the
   eventual harmonic-cap theorem
   ...
   now needs only the deterministic round-allocation inequalities. Remaining
   work is to instantiate
   `BMatchingTheorem9RelabelSymmetricPointwiseFamilyCertificate` by giving the
   input relabeling equivalence and proving the pointwise online-information
   identity for the modeled deterministic algorithms.
