...
4. Finally connect that certificate to the paper's `1 - 1/e` guarantee and
   instantiate the family-level small-bids and convergence assumptions for the
   paper's arrival/instance model.
