...
6. Section 7 now has the finite Yao/minimax expectation lemma, the uniform
   ...
   `BMatchingTheorem9FeasibleObservedPrefixFamilyCertificate` by supplying the
   concrete deterministic prefix allocation and capped-revenue field.
