...
6. Section 7 now has the finite Yao/minimax expectation lemma, the uniform
   ...
   algorithms and compare `theorem9NormalizedRevenueUpperBound` to `msvvRatio`
   in the intended large-market limit.
