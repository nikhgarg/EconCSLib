...
4. Finally connect that certificate to the paper's `1 - 1/e` guarantee and
   refine the model-level small-bids limiting assumptions for the paper's
   arrival/instance model.
