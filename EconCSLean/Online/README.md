...
6. Section 7 now has the finite Yao/minimax expectation lemma, the uniform
   ...
   `BMatchingTheorem9ObservedPrefixFamilyCertificate` by supplying the concrete
   deterministic allocation that factors through `theorem9ObservedPrefix`,
   plus the capacity, ineligible-zero, and capped-revenue fields.
