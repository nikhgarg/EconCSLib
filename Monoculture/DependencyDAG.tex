...
\node[lemma, below=of DeltaCert] (SwapGeom) {score swap map /\\density product inequalities};
\node[lemma, right=3cm of SwapGeom, yshift=-0.6cm] (PreimageBridge) {finite preimage bridge:\\event marginals from atoms};
