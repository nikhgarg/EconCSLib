...
| Theorem 1, full monoculture paradox existence over accuracy families | `AccuracyFamily.Theorem1Target` | interface-exposed, proof scaffold still in `Monoculture/Family.lean` | `Monoculture/MainTheorems.lean` + `Monoculture/Family.lean` | connect paper hypotheses to paradox and instantiate the accuracy-family existence proof |
