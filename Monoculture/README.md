...
| Theorem 3, rank-factorized independent-reranking and weaker-competition route | `MallowsComparison.paper_theorem3_pointwise_rankFactorization`, `MallowsComparison.cross_weight_sum_pos_of_rankFactorization`, `candidateRankCrossConditionalGapSum_pos`, `candidateRankWeightedAverage_strictAnti` | formalized | `Monoculture/MainTheorems.lean`, `Monoculture/MallowsPairwise.lean` | strict center ordering, `0 < n`, algorithm/human `RankFactorization`, `q < 1`, strict `qA < qH`; the total weaker-competition sum is proved by the Appendix-E conditional-gap/MLR route |
| Finite Mallows top-one fiber factorization | `reflFirstWeight_eq_rank_mul_zero`, `MallowsSpec.firstWeight_eq_reflFirstWeight`, `MallowsSpec.firstWeight_eq_rank_mul_centerFirst`, `MallowsSpec.partition_eq_rankPowerSum_mul_centerFirstWeight` | formalized | `Monoculture/Kendall.lean`, `Monoculture/MallowsPairwise.lean` | none for top-one fibers; ordered top-two fibers remain to package the full `RankFactorization` constructor |
