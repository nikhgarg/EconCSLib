...
| Theorem 1, inequality (5) from monotonicity | `paper_theorem1_inequality5_from_monotonicity`, `AccuracyFamily.Theorem1MonotonicityAt` | conditional | `Monoculture/MainTheorems.lean`, `Monoculture/Theorem1.lean` | monotonicity certificate not yet derived from Definition 1 |
| Theorem 1, final right-nudge/payoff bridge to monoculture paradox | `paper_theorem1_from_right_nudge_certificate`, `paper_theorem1_from_crossing_certificate`, `AccuracyFamily.theorem1Target_of_rightNudgeCertificate`, `AccuracyFamily.theorem1Target_of_crossingCertificate`, `AccuracyFamily.theorem1Target_of_payoffCertificate` | formalized conditional bridge | `Monoculture/MainTheorems.lean`, `Monoculture/Theorem1.lean` | requires `AccuracyFamily.Theorem1RightNudgeCertificate F θH` or `AccuracyFamily.Theorem1CrossingCertificate F θH` |
| Theorem 1, full monoculture paradox existence over accuracy families | `AccuracyFamily.Theorem1Target` | conditional | `Monoculture/MainTheorems.lean`, `Monoculture/Family.lean`, `Monoculture/Theorem1.lean` | remaining analytic task: derive `AccuracyFamily.Theorem1RightNudgeCertificate F θH` from Definition 1 differentiability/asymptotic optimality/monotonicity plus Definitions 2 and 3 |
