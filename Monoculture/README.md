...
| Theorem 1, final atom-local/local-nudge/right-nudge/payoff bridge to monoculture paradox | `paper_theorem1_from_atom_local_nudge_certificate`, `paper_theorem1_from_local_nudge_certificate`, `paper_theorem1_from_right_nudge_certificate`, `paper_theorem1_from_crossing_certificate`, `AccuracyFamily.theorem1Target_of_atomLocalNudgeCertificate`, `AccuracyFamily.theorem1Target_of_localNudgeCertificate`, `AccuracyFamily.theorem1Target_of_rightNudgeCertificate`, `AccuracyFamily.theorem1Target_of_crossingCertificate`, `AccuracyFamily.theorem1Target_of_payoffCertificate` | formalized conditional bridge | `Monoculture/MainTheorems.lean`, `Monoculture/Theorem1.lean` | requires `AccuracyFamily.Theorem1AtomLocalNudgeCertificate F θH`, `AccuracyFamily.Theorem1LocalNudgeCertificate F θH`, `AccuracyFamily.Theorem1RightNudgeCertificate F θH`, or `AccuracyFamily.Theorem1CrossingCertificate F θH`; the atom-local certificate proves `f < h` persistence from finite atomwise continuity |
| Theorem 1, full monoculture paradox existence over accuracy families | `AccuracyFamily.Theorem1Target` | conditional | `Monoculture/MainTheorems.lean`, `Monoculture/Family.lean`, `Monoculture/Theorem1.lean` | remaining analytic task: derive the right-neighborhood `g < f` crossing field in `AccuracyFamily.Theorem1AtomLocalNudgeCertificate F θH` from Definition 1 differentiability/asymptotic optimality plus Definitions 2 and 3 |
