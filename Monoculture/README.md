...
| Appendix-E top-two expansion for independent reranking | `MallowsSpec.firstChoiceGapWeight_eq_sum_firstSecondWeight`, `MallowsSpec.independent_weight_sum_eq_pair_sum` | formalized | `Monoculture/MallowsPairwise.lean` | none |
