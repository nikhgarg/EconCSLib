...
| `papers/GHW01DigitalGoods` | *Competitive Auctions and Digital Goods* | Partially formalized | Digital-goods primitives, fixed-price support, Section 6 sampling support, and the Section 7.2 weighted-pairing `F^(2)` lower bound are formalized under the natural-number log certificate; Section 4 exact log packaging, Section 7.2 concrete tightness-family instantiation, and Sections 8--9 general-auction wrappers remain open. |
