...
| [EOS07 GSP](papers/EOS07GSP) | Partially formalized | 0/17 | OK: 83 lines | Non-truthfulness, examples, and finite theorem endpoints are exposed with an explicit completion boundary. |
