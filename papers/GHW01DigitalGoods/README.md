...
ranked-bin weighted-pairing bridge, the closed Theorem 7.2 `F^(2)` lower bound
under the natural-number log certificate, Lemma 8.1, and Lemma 9.2. The
remaining open endpoints are the Section 4 exact log-partition packaging, the
