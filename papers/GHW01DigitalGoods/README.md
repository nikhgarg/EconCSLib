...
| Lemma 9.2, truthful deterministic auctions are bid-independent | `paper_lemma9_2_deterministic_offer_payment_constant`, `paper_lemma9_2_deterministic_offer_winning_monotone`, `paper_lemma9_2_deterministic_offer_losing_prefix`, `paper_lemma9_2_deterministic_offer_bid_independent` | conditional scaffold | `GHW01DigitalGoods/MainTheorems.lean` | deterministic offer-slice critical-price characterization formalized without an infimum assumption; needs assembly from offer slices back to the full auction-level bid-independent predicate |
| Theorem 9.3, deterministic truthful lower bound | `paper_theorem9_3_deterministic_truthful_lower_bound_of_count_threshold` | conditional scaffold | `GHW01DigitalGoods/MainTheorems.lean` | reduction from count-threshold bid-independent rule to the Theorem 9.1 lower-bound witness formalized; needs full auction-level conversion from deterministic truthful auctions via Lemma 9.2 |
