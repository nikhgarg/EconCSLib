...
export EconCSLib.Auction (
  ...
  weightedPairingExpectedRevenue_nonneg_of_den_nonneg
  ...
  PaperTheorem62FairCoinSortedModel
  ...
  finiteCandidateOfferPrice_ge_one_of_benchmark_pos
  singlePriceRevenue_le_totalBidValue_of_nonneg
  ...
  PaperCorollary42TruncationModel
  paper_corollary4_2_fixed_price_lower_bound_of_truncation_model
  ...
  paper_totalBidValue_eq_sum_classifier_bins
  ...
  paper_theorem7_1_weighted_pairing_log_bound_from_log_certificate
  paper_two_pow_nat_ceil_logb_le_two_mul
  ...
  paper_weighted_pairing_den_pos_of_value_lt_total
  ...
  paper_theorem7_2_dyadicGeometricTail
  paper_theorem7_2_dyadicGeometricTail_eq_sum_range
  ...
  paper_theorem7_2_floor_mass_le_largest_bucket_total
  paper_theorem7_2_exists_largest_tail_bucket
  paper_theorem7_2_largestTailBucketIndex
  paper_theorem7_2_largestTailBucketIndex_lt
  paper_theorem7_2_largestTailBucketIndex_largest
  paper_theorem7_2_dyadicTailBucket
  paper_theorem7_2_dyadicTailBucket_floor
  paper_theorem7_2_dyadicTailBucket_upper
  paper_theorem7_2_winners_subset_dyadicTailBuckets
  paper_theorem7_2_winners_subset_dyadicTailBuckets_of_power_bound
  paper_theorem7_2_largestDyadicTailBucketIndex
  ...
  paper_theorem7_2_weighted_pairing_bound_from_classifier_and_tail_certificates
  ...
  paper_theorem7_2_weighted_pairing_bound_from_classifier_and_value_floor_bucket_family
  paper_theorem7_2_weighted_pairing_bound_from_power_two_bins_and_value_floor_bucket_family
  paper_theorem7_2_weighted_pairing_bound_from_power_two_bins_large_benchmark
  ...
  paper_theorem7_2_tightness_ratio_from_classifier
  paper_theorem7_2_tightness_ratio_from_classifier_benchmark_ge
  GhwTightLowerAgent
  GhwTightAgent
  ghwTightValue
  ghwTightClassifier
  paper_theorem7_2_tightness_lower_level_total
  paper_theorem7_2_tightness_lower_total
  paper_theorem7_2_tightness_totalBidValue
  paper_theorem7_2_tightness_top_saleCount_ge
  paper_theorem7_2_tightness_singlePriceRevenue_top
  paper_theorem7_2_tightness_top_revenue_le_twoWinnerBenchmark
  ghwTightTwoWinnerBenchmarkValue
  paper_theorem7_2_tightness_lower_square_sum_le
  paper_theorem7_2_tightness_square_sum_le
  paper_theorem7_2_tightness_lower_prefix_square_sum_le
  paper_theorem7_2_tightness_lower_payment_le
  ...
  paper_theorem8_2_expected_revenue_le_finite_candidate_benchmark_of_ranked_pairwise_truthfulness
  paper_theorem8_2_expected_revenue_le_finite_candidate_benchmark_of_ranked_pairwise_truthful_payments
  RankedAdjacentReportSymmetry
  ...
  twoValueHighCountInList
  twoValueLowCountInList
  twoValueCountListPriceRule
  ...
  DeterministicOfferBidIndependent
  ...
  paper_lemma9_2_deterministic_offer_exists_threshold_dominates
  ...
  PaperTheorem93CountThresholdAuctionFamilyCertificate
  ...
  paper_theorem9_3_deterministic_truthful_lower_bound_of_count_threshold_auction_family_certificate
  ...
  paper_theorem9_3_binary_anonymous_bid_independent_revenue_upper_bound_of_representation
  ...
  paper_theorem9_3_deterministic_truthful_lower_bound_of_anonymous_auction_family_certificate
  ...
  PaperTheorem93AnonymousTruthfulDeterministicModel
  ...
  PaperTheorem93AnonymousDeterministicTruthfulCertificate
  paper_theorem9_3_deterministic_truthful_lower_bound_of_certificate
  paper_theorem9_3_deterministic_truthful_ratio_witness_of_certificate
