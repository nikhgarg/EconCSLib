...
theorem audit_theorem8_bstar_ranked_threshold_strategy_step_new_dropout_record_eq_threshold_of_no_overshoot
  ...
  exact
    paper_theorem8_bstar_ranked_threshold_strategy_step_new_dropout_record_eq_threshold_of_no_overshoot
      model hstep hactive hinactive hno_overshoot

/-- Audit for the step-level source boundary: no-overshoot at a realized
dropout is equivalent to recording the finite `B*` threshold exactly. -/
theorem audit_theorem8_strategy_step_new_dropout_no_overshoot_iff_record_eq_threshold
    (model : PaperTheorem8BStarRankedThresholdLocalOptimalityCertificate)
    {state next : PaperTheorem8GeneralizedEnglishAuctionState ℕ}
    {rank : ℕ}
    (hstep :
      ...
      next.lastDropout rank =
        some
          (paper_theorem8_bstar_threshold_bid
            model.value model.clickThroughRate (model.remaining + 1)
            (rank + 1)) := by
  simpa [PaperInterface.theorem8BStarThresholdBid] using
    PaperInterface.theorem8_strategy_step_new_dropout_no_overshoot_iff_record_eq_threshold
      model hstep hactive hinactive
...
/-- Audit for the exact-record form of the realized-new-dropout source-timing
bridge: local no-overshoot evidence at each realized dropout upgrades an
ordinary generated history directly to exact finite `B*` dropout records. -/
theorem audit_theorem8_bstar_ranked_threshold_strategy_history_to_exact_drop_history_of_realized_new_dropout_no_overshoot
    (model : PaperTheorem8BStarRankedThresholdLocalOptimalityCertificate)
    {state finalState : PaperTheorem8GeneralizedEnglishAuctionState ℕ}
    (hhist :
      PaperTheorem8GeneralizedEnglishAuctionState.StrategyHistory
...
/-- Audit for reusing exact finite `B*` histories as no-overshoot source
histories. This lets exact-record source constructions feed the no-overshoot
terminal-record checker family directly. -/
theorem audit_theorem8_exact_drop_history_to_no_overshoot_strategy_history
    (model : PaperTheorem8BStarRankedThresholdLocalOptimalityCertificate)
    {state finalState : PaperTheorem8GeneralizedEnglishAuctionState ℕ}
    (hhist :
    ...
    PaperTheorem8BStarRankedThresholdNoOvershootStrategyHistory
      model state finalState := by
  exact
    PaperInterface.theorem8_exact_drop_history_to_no_overshoot_strategy_history
      model hhist

/-- Audit for the exact-history route into the preferred no-overshoot
terminal-history certificate. -/
def audit_theorem8_no_overshoot_terminal_certificate_of_exact_drop_history
    (model : PaperTheorem8BStarRankedThresholdLocalOptimalityCertificate)
    {state finalState : PaperTheorem8GeneralizedEnglishAuctionState ℕ}
    (hhist :
      PaperTheorem8BStarRankedThresholdExactDropHistory model state finalState)
  ...
  PaperInterface.theorem8_no_overshoot_terminal_certificate_of_exact_drop_history
    model hhist terminal initially_active

/-- Audit for the named exact-record bridge in Theorem 8: once the
realized-new-dropout no-overshoot statement is proved, any generated
named-strategy history has exact finite `B*` dropout records. -/
theorem audit_theorem8_bstar_ranked_threshold_strategy_history_to_exact_drop_history_of_realized_new_dropout_no_overshoot_statement
    (model : PaperTheorem8BStarRankedThresholdLocalOptimalityCertificate)
    {state finalState : PaperTheorem8GeneralizedEnglishAuctionState ℕ}
    (hhist :
      PaperTheorem8GeneralizedEnglishAuctionState.StrategyHistory
...
theorem audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_final_record_eq_threshold
  ...
  exact
    paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_final_record_eq_threshold
      model hhist hstate_no_overshoot hinitial_active hfinal_inactive
...
/-- Audit for clock-disciplined finite-`B*` traces: if a rank starts active and
is inactive at the final state, its terminal record is exactly the finite
`B*` threshold bid. -/
theorem audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_final_record_eq_threshold
    (model : PaperTheorem8BStarRankedThresholdLocalOptimalityCertificate)
    {state finalState : PaperTheorem8GeneralizedEnglishAuctionState ℕ}
    (htrace :
  ...
  exact
    paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_final_record_eq_threshold
      model htrace hstate_no_overshoot hinitial_active hfinal_inactive

/-- Audit for cold-start clock-disciplined finite-`B*` traces: the paper
cold-start state discharges the initial no-overshoot premise for the per-rank
terminal-record bridge. -/
theorem audit_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_trace_final_record_eq_threshold
    (model : PaperTheorem8BStarRankedThresholdLocalOptimalityCertificate)
    {finalState : PaperTheorem8GeneralizedEnglishAuctionState ℕ}
    (htrace :
      PaperTheorem8BStarRankedThresholdClockDisciplinedStrategyTrace
    ...
    finalState.lastDropout rank =
      some
        (paper_theorem8_bstar_threshold_bid
          ...
          (rank + 1)) := by
  exact
    audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_final_record_eq_threshold
      model htrace
      (paper_theorem8_bstar_ranked_threshold_cold_start_initial_no_overshoot
        model hvalue_nonneg hclick_mono hclick_pos)
      (by rfl) hfinal_inactive
...
def audit_theorem8_bstar_ranked_threshold_strict_ordered_one_step_tie_break_core_source_completion_certificate_of_one_sided
    {Belief : Type*}
    (cert :
      PaperTheorem8BStarRankedThresholdStrictOrderedOneSidedSourceCompletionCertificate
        Belief) :
...
/-- Audit for Theorem 8 strict ordered source-completion: the ex-post
one-sided source certificate also packages as the local one-step/tie-break core
certificate. -/
def audit_theorem8_bstar_ranked_threshold_strict_ordered_one_step_tie_break_core_source_completion_certificate_of_ex_post_one_sided
    {Belief : Type*}
    (cert :
    ...
    PaperTheorem8BStarRankedThresholdStrictOrderedOneStepTieBreakCoreSourceCompletionCertificate
      Belief := by
  exact
    paper_theorem8_bstar_ranked_threshold_strict_ordered_one_step_tie_break_core_source_completion_certificate_of_ex_post_one_sided
      cert
...
def audit_theorem8_source_sequential_sequential_rationality_iff_source_target :=
  PaperInterface.theorem8_source_sequential_sequential_rationality_iff_source_target

def audit_theorem8_source_sequential_pbe_iff_local_deviation :=
  PaperInterface.theorem8_source_sequential_pbe_iff_local_deviation

def audit_theorem8_source_sequential_sequential_rationality_iff_local_deviation :=
  PaperInterface.theorem8_source_sequential_sequential_rationality_iff_local_deviation

def audit_theorem8_source_sequential_unit_belief_consistent :=
  PaperInterface.theorem8_source_sequential_unit_belief_consistent

def audit_theorem8_source_sequential_named_strategy_sequentially_rational :=
  PaperInterface.theorem8_source_sequential_named_strategy_sequentially_rational

def audit_theorem8_source_sequential_named_strategy_pbe_from_unit_belief :=
  PaperInterface.theorem8_source_sequential_named_strategy_pbe_from_unit_belief
...
def audit_theorem8_bstar_ranked_threshold_strict_ordered_no_overshoot_terminal_dynamic_exists_unique_pbe_with_trace_full_conclusion
    {Belief : Type*} :=
...
def audit_theorem8_bstar_ranked_threshold_strict_ordered_source_sequential_no_overshoot_terminal_dynamic_exists_unique_pbe_with_trace_full_all_completed_rank_terminal_record_conclusion_of_clock_sorted_nodup_unscheduled_threshold_gt :=
...
def audit_theorem8_source_sequential_schedule_trace_full_all_completed_rank_conclusion :=
  PaperInterface.theorem8_source_sequential_schedule_trace_full_all_completed_rank_conclusion
...
def audit_theorem8_bstar_ranked_threshold_strict_ordered_source_sequential_no_overshoot_terminal_dynamic_exists_unique_pbe_with_trace_full_all_completed_rank_terminal_record_conclusion_of_cold_start_threshold_sorted_nodup_last_threshold_lt_unscheduled :=
...
def audit_theorem8_source_sequential_cold_start_threshold_sorted_trace_full_all_completed_rank_conclusion :=
  PaperInterface.theorem8_source_sequential_cold_start_threshold_sorted_trace_full_all_completed_rank_conclusion
...
def audit_theorem8_terminal_record_source_sequential_rationality_iff_source_target :=
  PaperInterface.theorem8_terminal_record_source_sequential_rationality_iff_source_target

def audit_theorem8_terminal_record_source_sequential_rationality_iff_local_deviation :=
  PaperInterface.theorem8_terminal_record_source_sequential_rationality_iff_local_deviation

def audit_theorem8_terminal_record_source_pbe_iff_source_target :=
  PaperInterface.theorem8_terminal_record_source_pbe_iff_source_target

def audit_theorem8_terminal_record_source_pbe_iff_local_deviation :=
  PaperInterface.theorem8_terminal_record_source_pbe_iff_local_deviation

def audit_theorem8_terminal_record_source_pbe_iff_named_strategy :=
  PaperInterface.theorem8_terminal_record_source_pbe_iff_named_strategy
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_sequential_dynamic_game_exists_unique_pbe_with_all_completed_rank_paper_conclusion_of_clock_sorted_nodup_unscheduled_threshold_gt :=
  paper_theorem8_bstar_ranked_threshold_terminal_record_source_sequential_dynamic_game_exists_unique_pbe_with_all_completed_rank_paper_conclusion_of_clock_sorted_nodup_unscheduled_threshold_gt
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_sequential_dynamic_game_exists_unique_pbe_with_all_completed_rank_paper_conclusion_of_strict_ordered_cold_start_threshold_sorted_nodup_last_threshold_lt_unscheduled :=
  paper_theorem8_bstar_ranked_threshold_terminal_record_source_sequential_dynamic_game_exists_unique_pbe_with_all_completed_rank_paper_conclusion_of_strict_ordered_cold_start_threshold_sorted_nodup_last_threshold_lt_unscheduled
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_belief_source_extensive_consistent_belief_history_terminal :=
  paper_theorem8_bstar_ranked_threshold_terminal_record_belief_source_extensive_consistent_belief_history_terminal

def audit_theorem8_bstar_ranked_threshold_terminal_record_belief_source_extensive_sequential_rationality_iff_local_deviation :=
...
def audit_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_belief_source_extensive_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_exact_drop_history_belief_source_extensive_trace_all_terminal_vcg_conclusion :=
  PaperInterface.theorem8_exact_drop_history_belief_source_extensive_trace_all_terminal_vcg_conclusion
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_belief_source_extensive_dynamic_game_exists_unique_pbe_with_trace_all_terminal_vcg_conclusion_of_clock_disciplined_strategy_trace :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_belief_source_extensive_dynamic_game_exists_unique_pbe_with_trace_completed_rank_paper_conclusion_of_no_overshoot :=
...
def audit_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_belief_source_extensive_trace_completed_rank_paper_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_belief_source_extensive_trace_completed_rank_paper_conclusion_of_completed_threshold_le :=
...
def audit_theorem8_exact_drop_history_belief_source_extensive_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_exact_drop_history_belief_source_extensive_trace_completed_threshold_conclusion
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_belief_source_extensive_dynamic_game_exists_unique_pbe_with_trace_completed_rank_paper_conclusion_of_clock_disciplined_terminal_history_inactive_completed :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_terminal_record_belief_source_extensive_dynamic_game_exists_unique_pbe_with_trace_completed_rank_paper_conclusion_of_clock_disciplined_terminal_history_inactive_completed :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_belief_source_extensive_dynamic_game_exists_unique_pbe_with_all_completed_rank_paper_conclusion_of_clock_sorted_nodup_unscheduled_threshold_gt :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_belief_source_extensive_dynamic_game_exists_unique_pbe_with_trace_all_completed_rank_paper_conclusion_of_clock_sorted_nodup_unscheduled_threshold_gt :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_step_allows_unsafe_advance :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_step_allows_unsafe_advance

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_step_not_global_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_step_not_global_advance_safe
...
def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_allows_overshoot_not_exact_drop_history :=
  paper_theorem8_bstar_ranked_threshold_source_extensive_rationality_allows_overshoot_not_exact_drop_history

noncomputable def audit_theorem8_bstar_ranked_threshold_strict_ordered_no_overshoot_terminal_dynamic_certificate_of_strategy_history_advance_safe :=
...
noncomputable def audit_theorem8_bstar_ranked_threshold_strict_ordered_no_overshoot_terminal_dynamic_certificate_of_strategy_history_local_advance_safe
    {Belief : Type*} :=
...
def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_source_iff_full_conclusion
    {Belief : Type*} :=
  @paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_source_iff_full_conclusion
    Belief

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_source_iff_full_conclusion
    {Belief : Type*} :=
  @paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_source_iff_full_conclusion
    Belief

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_source_iff_completed_threshold_conclusion
    {Belief : Type*} :=
  @paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_source_iff_completed_threshold_conclusion
    Belief

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_source_iff_completed_threshold_conclusion
    {Belief : Type*} :=
  @paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_source_iff_completed_threshold_conclusion
    Belief

def audit_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_source_iff_full_conclusion
    {Belief : Type*} :=
  @paper_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_source_iff_full_conclusion
    Belief

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_source_iff_full_conclusion
    {Belief : Type*} :=
  @paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_source_iff_full_conclusion
    Belief

def audit_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_source_iff_completed_threshold_conclusion
    {Belief : Type*} :=
  @paper_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_source_iff_completed_threshold_conclusion
    Belief

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_source_iff_completed_threshold_conclusion
    {Belief : Type*} :=
...
def audit_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_trans :=
...
def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_trans :=
  PaperTheorem8BStarRankedThresholdClockDisciplinedStrategyHistory.trans

def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_trans :=
  PaperTheorem8BStarRankedThresholdClockDisciplinedStrategyTrace.trans

def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_step_to_trace :=
  paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_step_to_trace

def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_append_step :=
  paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_append_step

def audit_theorem8_bstar_ranked_threshold_strategy_step_to_clock_disciplined_strategy_step_of_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_strategy_step_to_clock_disciplined_strategy_step_of_advance_safe

def audit_theorem8_bstar_ranked_threshold_strategy_step_preserves_state_no_overshoot_of_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_strategy_step_preserves_state_no_overshoot_of_advance_safe

def audit_theorem8_bstar_ranked_threshold_strategy_step_realized_new_dropout_no_overshoot_of_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_strategy_step_realized_new_dropout_no_overshoot_of_advance_safe

def audit_theorem8_bstar_ranked_threshold_strategy_step_new_dropout_record_eq_threshold_of_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_strategy_step_new_dropout_record_eq_threshold_of_advance_safe

abbrev audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe :=
  PaperTheorem8BStarRankedThresholdStrategyHistoryAdvanceSafe

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_on_history_of_global :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_on_history_of_global

def audit_theorem8_bstar_ranked_threshold_strategy_history_to_clock_disciplined_strategy_trace_of_history_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_to_clock_disciplined_strategy_trace_of_history_advance_safe

def audit_theorem8_bstar_ranked_threshold_strategy_history_to_clock_disciplined_strategy_history_of_history_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_to_clock_disciplined_strategy_history_of_history_advance_safe

def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_to_strategy_history_local_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_to_strategy_history_local_advance_safe

def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_to_strategy_history_local_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_to_strategy_history_local_advance_safe

def audit_theorem8_bstar_ranked_threshold_exact_drop_schedule_clock_sorted_nodup_to_strategy_history_local_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_exact_drop_schedule_clock_sorted_nodup_to_strategy_history_local_advance_safe

def audit_theorem8_bstar_ranked_threshold_exact_drop_schedule_clock_sorted_nodup_to_strategy_history_local_advance_safe_of_final_clock_lt_unscheduled :=
...
def audit_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_to_no_overshoot_strategy_history :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_to_no_overshoot_strategy_history

def audit_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_exact_drop_history :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_exact_drop_history

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_to_no_overshoot_strategy_history :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_to_no_overshoot_strategy_history

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_exact_drop_history :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_exact_drop_history

def audit_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_source_extensive_exact_drop_obligations :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_source_extensive_exact_drop_obligations

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_source_extensive_exact_drop_obligations :=
...
def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_to_clock_disciplined_strategy_trace_of_history_advance_safe :=
...
def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_source_extensive_local_advance_safe_obligations :=
  paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_source_extensive_local_advance_safe_obligations

def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_source_extensive_local_advance_safe_obligations :=
  paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_trace_source_extensive_local_advance_safe_obligations

def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_local_advance_safe_exact_drop_obligations :=
  paper_theorem8_bstar_ranked_threshold_source_extensive_rationality_local_advance_safe_exact_drop_obligations

def audit_theorem8_bstar_ranked_threshold_cold_start_source_extensive_rationality_local_advance_safe_exact_drop_obligations :=
  paper_theorem8_bstar_ranked_threshold_cold_start_source_extensive_rationality_local_advance_safe_exact_drop_obligations

def audit_theorem8_bstar_ranked_threshold_exact_drop_schedule_clock_sorted_nodup_source_extensive_local_advance_safe_exact_drop_obligations_of_final_clock_lt_unscheduled :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_exact_drop_schedule_clock_sorted_nodup_source_extensive_local_advance_safe_exact_drop_obligations_of_final_clock_lt_unscheduled :=
...
def audit_theorem8_bstar_ranked_threshold_strict_ordered_cold_start_threshold_sorted_append_singleton_source_extensive_local_advance_safe_exact_drop_obligations :=
...
def audit_theorem8_bstar_ranked_threshold_strict_ordered_cold_start_threshold_sorted_append_singleton_source_extensive_local_advance_safe_trace_completed_rank_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_strict_ordered_cold_start_threshold_sorted_append_singleton_source_extensive_local_advance_safe_ex_post_source_completion_trace_full_completed_rank_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_strategy_history_to_clock_disciplined_strategy_trace_of_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_to_clock_disciplined_strategy_trace_of_advance_safe

def audit_theorem8_bstar_ranked_threshold_strategy_history_to_clock_disciplined_strategy_history_of_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_to_clock_disciplined_strategy_history_of_advance_safe

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_preserves_state_no_overshoot :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_preserves_state_no_overshoot

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_preserves_state_no_overshoot :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_preserves_state_no_overshoot

def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_to_clock_disciplined_strategy_trace_of_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_source_extensive_rationality_to_clock_disciplined_strategy_trace_of_advance_safe

def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_advance_safe_exact_drop_obligations :=
  paper_theorem8_bstar_ranked_threshold_source_extensive_rationality_advance_safe_exact_drop_obligations

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_to_no_overshoot_strategy_history :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_to_no_overshoot_strategy_history

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_exact_drop_history :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_exact_drop_history

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_final_record_eq_threshold :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_final_record_eq_threshold

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_terminal_records_eq_thresholds :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_terminal_records_eq_thresholds

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_terminal_record_outcome_eq_bstar :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_terminal_record_outcome_eq_bstar

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_terminal_record_ordered_paper_conclusion :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_terminal_record_ordered_paper_conclusion

def audit_theorem8_bstar_ranked_threshold_no_overshoot_terminal_history_behavior_certificate_of_strategy_history_advance_safe :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_to_no_overshoot_strategy_history :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_to_no_overshoot_strategy_history

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_exact_drop_history :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_exact_drop_history

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_final_record_eq_threshold :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_final_record_eq_threshold

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_terminal_records_eq_thresholds :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_terminal_records_eq_thresholds

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_terminal_record_outcome_eq_bstar :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_terminal_record_outcome_eq_bstar

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_terminal_record_ordered_paper_conclusion :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_terminal_record_ordered_paper_conclusion

def audit_theorem8_bstar_ranked_threshold_no_overshoot_terminal_history_behavior_certificate_of_cold_start_strategy_history_advance_safe :=
  paper_theorem8_bstar_ranked_threshold_no_overshoot_terminal_history_behavior_certificate_of_cold_start_strategy_history_advance_safe

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_source_extensive_exact_drop_obligations :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_source_extensive_exact_drop_obligations

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_source_extensive_exact_drop_obligations :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_source_extensive_exact_drop_obligations

def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_advance_safe_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_source_extensive_rationality_advance_safe_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_advance_safe_belief_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_source_extensive_rationality_advance_safe_belief_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_belief_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_advance_safe_belief_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_local_advance_safe_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_source_extensive_rationality_local_advance_safe_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_source_extensive_rationality_local_advance_safe_belief_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_source_extensive_rationality_local_advance_safe_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_source_extensive_rationality_local_advance_safe_trace_completed_threshold_conclusion

def audit_theorem8_source_extensive_rationality_local_advance_safe_belief_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_source_extensive_rationality_local_advance_safe_belief_trace_completed_threshold_conclusion

def audit_theorem8_strategy_history_local_advance_safe_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_strategy_history_local_advance_safe_trace_completed_threshold_conclusion

def audit_theorem8_strategy_history_local_advance_safe_belief_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_strategy_history_local_advance_safe_belief_trace_completed_threshold_conclusion

def audit_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_belief_trace_completed_rank_paper_conclusion_of_completed_threshold_le :=
...
def audit_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_belief_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_local_advance_safe_belief_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_cold_start_source_extensive_rationality_local_advance_safe_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_source_extensive_rationality_local_advance_safe_belief_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_cold_start_source_extensive_rationality_local_advance_safe_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_cold_start_source_extensive_rationality_local_advance_safe_trace_completed_threshold_conclusion

def audit_theorem8_cold_start_source_extensive_rationality_local_advance_safe_belief_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_cold_start_source_extensive_rationality_local_advance_safe_belief_trace_completed_threshold_conclusion

def audit_theorem8_cold_start_strategy_history_local_advance_safe_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_cold_start_strategy_history_local_advance_safe_trace_completed_threshold_conclusion

def audit_theorem8_cold_start_strategy_history_local_advance_safe_belief_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_cold_start_strategy_history_local_advance_safe_belief_trace_completed_threshold_conclusion

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_local_advance_safe_belief_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_source_extensive_rationality_advance_safe_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_source_extensive_rationality_advance_safe_belief_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_cold_start_strategy_history_advance_safe_belief_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_history_to_no_overshoot :=
  paper_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_history_to_no_overshoot

def audit_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_history_to_exact_drop_history :=
  paper_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_history_to_exact_drop_history

def audit_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_trace_to_no_overshoot :=
  paper_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_trace_to_no_overshoot

def audit_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_trace_to_exact_drop_history :=
  paper_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_trace_to_exact_drop_history

def audit_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_source_extensive_exact_drop_obligations :=
  paper_theorem8_bstar_ranked_threshold_clock_disciplined_strategy_history_source_extensive_exact_drop_obligations

def audit_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_strategy_history_source_extensive_exact_drop_obligations :=
...
def audit_theorem8_bstar_ranked_threshold_no_overshoot_terminal_history_behavior_certificate_of_cold_start_clock_disciplined_strategy_history :=
...
def audit_theorem8_bstar_ranked_threshold_no_overshoot_terminal_history_behavior_certificate_of_no_overshoot_strategy_history :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_dynamic_game_exists_unique_pbe_with_trace_all_terminal_vcg_conclusion_of_clock_disciplined_strategy_trace :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_dynamic_game_exists_unique_pbe_with_trace_completed_rank_paper_conclusion_of_no_overshoot :=
...
def audit_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_source_extensive_completed_rank_paper_conclusion :=
  paper_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_source_extensive_completed_rank_paper_conclusion

def audit_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_source_extensive_trace_completed_rank_paper_conclusion :=
...
def audit_theorem8_exact_drop_history_source_extensive_trace_completed_rank_conclusion :=
  PaperInterface.theorem8_exact_drop_history_source_extensive_trace_completed_rank_conclusion

def audit_theorem8_exact_drop_history_source_extensive_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_exact_drop_history_source_extensive_trace_completed_threshold_conclusion

def audit_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_source_extensive_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_source_extensive_trace_all_terminal_vcg_conclusion

def audit_theorem8_exact_drop_history_source_extensive_trace_all_terminal_vcg_conclusion :=
  PaperInterface.theorem8_exact_drop_history_source_extensive_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_no_overshoot_strategy_history_source_extensive_completed_rank_paper_conclusion_of_completed_threshold_le :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_dynamic_game_exists_unique_pbe_with_trace_completed_rank_paper_conclusion_of_clock_disciplined_terminal_history_inactive_completed :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_terminal_record_source_extensive_dynamic_game_exists_unique_pbe_with_trace_completed_rank_paper_conclusion_of_clock_disciplined_terminal_history_inactive_completed :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_dynamic_game_exists_unique_pbe_with_all_completed_rank_paper_conclusion_of_clock_sorted_nodup_unscheduled_threshold_gt :=
...
def audit_theorem8_bstar_ranked_threshold_clock_disciplined_schedule_source_extensive_trace_completed_rank_conclusion :=
  paper_theorem8_bstar_ranked_threshold_clock_disciplined_schedule_source_extensive_trace_completed_rank_conclusion

def audit_theorem8_bstar_ranked_threshold_clock_disciplined_schedule_source_extensive_trace_completed_rank_conclusion_of_final_clock_lt_unscheduled :=
...
def audit_theorem8_bstar_ranked_threshold_clock_disciplined_schedule_source_extensive_trace_completed_rank_conclusion_of_final_clock_lt_unscheduled_derive_initial_no_overshoot :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_schedule_source_extensive_trace_completed_rank_conclusion :=
...
def audit_theorem8_bstar_ranked_threshold_cold_start_clock_disciplined_schedule_source_extensive_trace_completed_rank_conclusion_of_final_clock_lt_unscheduled :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_dynamic_game_exists_unique_pbe_with_trace_all_completed_rank_paper_conclusion_of_clock_sorted_nodup_unscheduled_threshold_gt :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_dynamic_game_exists_unique_pbe_with_all_completed_rank_paper_conclusion_of_strict_ordered_cold_start_threshold_sorted_nodup_last_threshold_lt_unscheduled :=
...
def audit_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_dynamic_game_exists_unique_pbe_with_trace_all_completed_rank_paper_conclusion_of_strict_ordered_cold_start_threshold_sorted_nodup_last_threshold_lt_unscheduled :=
...
def audit_theorem8_strict_ordered_local_deviation_terminal_history_certificate_singleton_terminal_record_and_active_iff :=
...
def audit_theorem8_strict_ordered_local_deviation_terminal_history_certificate_pair_terminal_records_and_active_iff :=
...
def audit_theorem8_strict_ordered_no_overshoot_terminal_history_ex_post_local_deviation_source_completion_exists_unique_pbe_with_trace_full_completed_rank_terminal_record_conclusion_of_completed_threshold_le :=
...
def audit_theorem8_strict_ordered_no_overshoot_terminal_history_ex_post_local_deviation_source_completion_exists_unique_pbe_with_trace_full_completed_rank_terminal_record_conclusion_of_local_deviation :=
...
def audit_theorem8_strict_ordered_finite_schedule_source_sequential_rationality_core_source_completion_all_scheduled_of_source_iff_clock_sorted_nodup
    {Belief : Type*} :=
...
def audit_theorem8_source_sequential_rationality_finite_schedule_source_iff_all_completed_source_completion
    {Belief : Type*} :=
  @PaperInterface.theorem8_source_sequential_rationality_finite_schedule_source_iff_all_completed_source_completion
    Belief
...
def audit_theorem8_source_extensive_rationality_realized_new_dropout_statement_trace_all_terminal_vcg_conclusion :=
  PaperInterface.theorem8_source_extensive_rationality_realized_new_dropout_statement_trace_all_terminal_vcg_conclusion

def audit_theorem8_source_extensive_rationality_realized_new_dropout_statement_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_source_extensive_rationality_realized_new_dropout_statement_trace_completed_threshold_conclusion

def audit_theorem8_source_extensive_rationality_realized_new_dropout_statement_belief_trace_completed_threshold_conclusion :=
  PaperInterface.theorem8_source_extensive_rationality_realized_new_dropout_statement_belief_trace_completed_threshold_conclusion

def audit_theorem8_bstar_ranked_threshold_strategy_history_realized_new_dropout_trace_all_terminal_vcg_conclusion :=
  paper_theorem8_bstar_ranked_threshold_strategy_history_realized_new_dropout_trace_all_terminal_vcg_conclusion

def audit_theorem8_bstar_ranked_threshold_strategy_history_realized_new_dropout_statement_trace_all_terminal_vcg_conclusion :=
...
def audit_theorem8_source_sequential_rationality_source_iff_histories_no_overshoot_all_pbe_outcome_eq_vcg
    {Belief : Type*} :=
  @PaperInterface.theorem8_source_sequential_rationality_source_iff_histories_no_overshoot_all_pbe_outcome_eq_vcg
    Belief
...
def audit_theorem8_no_overshoot_terminal_record_local_deviation_completed_threshold_conclusion :=
  PaperInterface.theorem8_no_overshoot_terminal_record_local_deviation_completed_threshold_conclusion

def audit_theorem8_terminal_record_local_deviation_cold_start_threshold_sorted_all_completed_conclusion :=
  PaperInterface.theorem8_terminal_record_local_deviation_cold_start_threshold_sorted_all_completed_conclusion

def audit_theorem8_terminal_record_local_deviation_cold_start_singleton_all_completed_conclusion :=
  PaperInterface.theorem8_terminal_record_local_deviation_cold_start_singleton_all_completed_conclusion

def audit_theorem8_terminal_record_local_deviation_cold_start_pair_all_completed_conclusion :=
  PaperInterface.theorem8_terminal_record_local_deviation_cold_start_pair_all_completed_conclusion

def audit_theorem8_local_deviation_cold_start_threshold_sorted_terminal_dynamic_full_conclusion :=
  PaperInterface.theorem8_local_deviation_cold_start_threshold_sorted_terminal_dynamic_full_conclusion

def audit_theorem8_local_deviation_cold_start_threshold_sorted_no_overshoot_full_conclusion :=
  PaperInterface.theorem8_local_deviation_cold_start_threshold_sorted_no_overshoot_full_conclusion
...
noncomputable def audit_theorem8_strict_ordered_source_extensive_rationality_realized_new_dropout_ex_post_source_completion_completed_threshold_conclusion :=
...
noncomputable def audit_theorem8_strict_ordered_source_extensive_rationality_realized_new_dropout_ex_post_source_completion_trace_full_completed_threshold_conclusion :=
...
noncomputable def audit_theorem8_strict_ordered_exact_drop_history_ex_post_source_completion_completed_threshold_conclusion :=
...
noncomputable def audit_theorem8_strict_ordered_exact_drop_history_ex_post_source_completion_trace_full_completed_threshold_conclusion :=
...
noncomputable def audit_theorem8_strict_ordered_exact_drop_history_ex_post_source_completion_utility_eq_bstar_of_completed_threshold :=
...
noncomputable def audit_theorem8_strict_ordered_source_extensive_rationality_exact_drop_history_ex_post_source_completion_completed_threshold_conclusion :=
...
noncomputable def audit_theorem8_strict_ordered_source_extensive_rationality_exact_drop_history_ex_post_source_completion_trace_full_completed_threshold_conclusion :=
...
noncomputable def audit_theorem8_strict_ordered_source_extensive_rationality_exact_drop_history_ex_post_source_completion_utility_eq_bstar_of_completed_threshold :=
...
noncomputable def audit_theorem8_strict_ordered_source_extensive_rationality_local_advance_safe_ex_post_source_completion_completed_threshold_conclusion :=
...
noncomputable def audit_theorem8_strict_ordered_source_extensive_rationality_local_advance_safe_ex_post_source_completion_trace_full_completed_threshold_conclusion :=
...
noncomputable def audit_theorem8_strict_ordered_source_extensive_rationality_local_advance_safe_ex_post_source_completion_utility_eq_bstar_of_completed_threshold :=
...
def audit_theorem8_strict_ordered_source_sequential_no_overshoot_terminal_history_source_completion_exists_unique_pbe_with_trace_full_completed_rank_terminal_record_conclusion_of_completed_threshold_le :=
...
def audit_theorem8_strict_ordered_source_sequential_no_overshoot_terminal_history_source_completion_exists_unique_pbe_with_trace_full_completed_rank_terminal_record_conclusion_of_inactive_completed :=
...
def audit_theorem8_strict_ordered_source_sequential_no_overshoot_terminal_history_source_completion_exists_unique_pbe_with_trace_full_completed_rank_terminal_record_conclusion_of_terminal_model :=
...
def audit_theorem8_strict_ordered_source_sequential_no_overshoot_terminal_history_source_completion_exists_unique_pbe_with_trace_full_completed_rank_terminal_record_conclusion_of_terminal_model_inactive_completed :=
...
def audit_theorem8_fin_schedule_ranks {n : ℕ}
    (scheduledRanks : List (Fin n)) : List ℕ :=
  paper_theorem8_bstar_ranked_threshold_fin_schedule_ranks scheduledRanks

theorem audit_theorem8_fin_schedule_ranks_nodup {n : ℕ}
    {scheduledRanks : List (Fin n)}
    (hnodup : scheduledRanks.Nodup) :
    (audit_theorem8_fin_schedule_ranks scheduledRanks).Nodup := by
  simpa [audit_theorem8_fin_schedule_ranks] using
    paper_theorem8_bstar_ranked_threshold_fin_schedule_ranks_nodup hnodup

def audit_theorem8_strict_ordered_fin_schedule_exact_record_final_state_no_active_of_threshold_sorted :=
  paper_theorem8_bstar_ranked_threshold_strict_ordered_fin_schedule_exact_record_final_state_no_active_of_threshold_sorted

def audit_theorem8_strict_ordered_complete_fin_schedule_displayed_ranks_active_then_inactive_of_threshold_sorted :=
...
def audit_theorem8_strict_ordered_fin_schedule_source_extensive_trace_full_vcg_conclusion_of_threshold_sorted :=
...
def audit_theorem8_strict_ordered_fin_schedule_source_extensive_named_pbe_trace_of_threshold_sorted :=
  paper_theorem8_bstar_ranked_threshold_strict_ordered_fin_schedule_source_extensive_named_pbe_trace_of_threshold_sorted

def audit_theorem8_strict_ordered_fin_schedule_source_extensive_displayed_rank_formulas_of_threshold_sorted :=
...
def audit_theorem8_strict_ordered_fin_schedule_belief_source_extensive_trace_full_vcg_conclusion_of_threshold_sorted :=
...
def audit_theorem8_strict_ordered_fin_schedule_belief_source_extensive_named_pbe_trace_of_threshold_sorted :=
...
def audit_theorem8_strict_ordered_fin_schedule_belief_source_extensive_displayed_rank_formulas_of_threshold_sorted :=
...
def audit_theorem8_terminal_record_source_extensive_cold_start_singleton_all_completed_conclusion :=
  paper_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_cold_start_singleton_all_completed_conclusion

def audit_theorem8_terminal_record_source_extensive_cold_start_pair_all_completed_conclusion :=
  paper_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_cold_start_pair_all_completed_conclusion

def audit_theorem8_terminal_record_source_extensive_cold_start_singleton_trace_all_completed_conclusion :=
...
def audit_theorem8_terminal_record_source_extensive_cold_start_pair_trace_all_completed_conclusion_statement :=
...
def audit_theorem8_terminal_record_source_extensive_cold_start_pair_trace_all_completed_conclusion :=
  paper_theorem8_bstar_ranked_threshold_terminal_record_source_extensive_cold_start_pair_trace_all_completed_conclusion

def audit_theorem8_terminal_record_source_extensive_cold_start_pair_or_swap_trace_all_completed_conclusion :=
...
def audit_theorem8_fresh_unscheduled_rank :=
  paper_theorem8_fresh_unscheduled_rank

def audit_theorem8_fresh_unscheduled_rank_not_mem :=
  paper_theorem8_fresh_unscheduled_rank_not_mem

def audit_theorem8_cold_start_clock_sorted_finite_schedule_leaves_active_unscheduled_rank :=
...
def audit_theorem8_belief_source_extensive_state_game_consistent_belief_history_terminal :=
...
def audit_theorem8_belief_source_extensive_state_game_sequential_rationality_iff_local_deviation :=
