...
and signal-precision scale gaps. Proposition 4.2 also has the named source
route through Lemma 4.1's lower-tail strategy-proofness bridge. It does not yet
formalize the paper's concrete strategic equilibrium model, Theorem 3.1/3.2, or
the final equilibrium/reporting bridge used in the source proofs.
