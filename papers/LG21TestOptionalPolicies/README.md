...
| Lemma 4.1, strategy-proofness when access is observed | `paper_lemma4_1_reporting_cutoff_has_profitable_deviation_core`, `paper_lemma4_1_gaussian_reporting_cutoff_has_profitable_deviation`, `paper_lemma4_1_no_nontrivial_gaussian_reporting_cutoff_of_no_profitable_withholding`, `paper_lemma4_1_no_nontrivial_gaussian_reporting_cutoff_of_no_profitable_withholding_from_cutoff`, `paper_lemma4_1_report_cutoff_estimate_lt_of_lower_tail_score`, `paper_lemma4_1_all_report_of_gaussian_lower_tail_cutoff_no_profitable_withholding`, `paper_lemma4_1_take_test_cutoff_has_profitable_deviation`, `paper_lemma4_1_no_nontrivial_take_test_cutoff_of_no_profitable_deviation`, `paper_lemma4_1_all_take_of_lower_tail_cutoff_no_profitable_test_taking`, `LG21ObservedAccessStrategyProofCertificate`, `paper_lemma4_1_strategy_proofness_of_certificate` | partially formalized | `MainTheorems.lean`, `PaperInterface.lean` | The optional-reporting proof now has the continuous strictly increasing cutoff-deviation core, its Gaussian posterior-score instantiation, and source-shaped lower-tail bridges: if the no-report estimate is the posterior at a lower-tail mean below the cutoff, any nontrivial reporting cutoff contradicts no-profitable-withholding, hence all report under the paper's threshold-if-not-all premise. The report-required proof has the Gaussian half-probability deviation witness and lower-tail all-take bridge. The final endpoint still depends on instantiating the monotonicity-to-threshold and truncated-mean premises from the concrete equilibrium predicate. |
