...
## Fastest Proof Route
   ...
   posterior-score formula is now shared; the next shared target is threshold
   and distribution-comparison lemmas.
...
3. Build an observed-access threshold best-response interface for Lemma 4.1
   ...
   available.
4. Use the posterior distribution comparison layer to discharge Proposition 4.2
   and Proposition 4.3 before attacking Theorem 3.1.
