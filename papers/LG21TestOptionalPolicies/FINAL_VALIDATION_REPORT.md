...
| Theorem 3.1, strategic withholding | 424, 829 | `audit_theorem3_1_section3_optional_reporting`, `audit_theorem3_1_section3_report_required`, PMF certificate aliases `audit_theorem3_1_section3_optional_reporting_pmf` and `audit_theorem3_1_section3_report_required_pmf`, finite-event-share source routes `audit_theorem3_1_optional_reporting_event_share_source_route` and `audit_theorem3_1_report_required_event_share_source_route`, plus finite-event-share continuous-law certificates `audit_theorem3_1_optional_reporting_event_share_law_certificate` and `audit_theorem3_1_report_required_event_share_law_certificate` |
