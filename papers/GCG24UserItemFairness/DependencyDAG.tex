...
\node[dag_lemma, right=of Problem11] (Problem11Dual)
  {\textbf{Problem 11 Dual} \\ Formal weak duality and closed left-pivot upper bound};
...
\node[dag_conditional, below=of Lemma13] (Lemma15)
  {\textbf{Lemma 15 (App. E)} \\ Coordinates; half-LP center $\lambda$ caveat};
...
\node[dag_unformalized, below=of VExist] (Theorem4Full)
  {\textbf{Theorem 4 (App. E)} \\ Open: real equality-form BFS existence};
...
\draw[dag_arrow] (Lemma14.east) -| (Theorem4Full.east);
\draw[dag_dashed_arrow] (Problem11Dual.south) |- (Theorem4Full.east);
