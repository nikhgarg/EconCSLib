...
\node[dag_lemma, below=of Lemma1] (Lemma2)
  {\textbf{Lemma 2 (App. C)} \\ Item-fairness LP epigraph};
...
\node[dag_model, right=of Lemma4] (Problem11)
  {\textbf{Problem 11 (App. E)} \\ Three-type LP and equality form};
...
\node[dag_conditional, below=of Lemma13] (Lemma15)
  {\textbf{Lemma 15 (App. E)} \\ Pivot-one coordinates; full formula open};

% --- Theorem 4 downstream wrappers and open paper theorem ---
\node[dag_unformalized, right=of NoGap] (Lemma14)
  {\textbf{Lemma 14 (App. E)} \\ Uniqueness of optimum};
...
\node[dag_result, below=of ColdBounds] (NoFairness)
  {\textbf{No-Fairness Side} \\ Estimated $\gamma=0$ benchmark};
\node[dag_lemma, right=of ColdBounds] (TrueLower)
  {\textbf{True-Model Lower Bound} \\ $U^*_{\min}(1,w) > 1/n$};
\node[dag_conditional, below=1.7cm of NoFairness, xshift=3.2cm] (Theorem4Conditional)
  {\textbf{Theorem 4 Wrappers} \\ Formalized from equality-form Problem 11};
\node[dag_unformalized, below=of Theorem4Conditional] (VExist)
  {\textbf{Value-Vector Witness} \\ Open $v_2 < \varepsilon v_1 / n$ construction};
\node[dag_unformalized, below=of VExist] (Theorem4Full)
  {\textbf{Theorem 4 (App. E)} \\ Full paper theorem not closed yet};
...
\draw[dag_arrow] (NoFairness) -- (Theorem4Conditional);
\draw[dag_arrow] (TrueLower) -- (Theorem4Conditional);
\draw[dag_arrow] (Theorem4Conditional) -- (VExist);
\draw[dag_arrow] (VExist) -- (Theorem4Full);
\draw[dag_dashed_arrow] (Lemma14.east) -| (Theorem4Full.east);
