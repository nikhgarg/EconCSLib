...
\node[dag_lemma, below=of Lemma13] (Lemma15)
  {\textbf{Lemma 15 (App. E)} \\ Coordinates from closed/equalized optimum};
...
\node[dag_conditional, below=1.7cm of NoFairness, xshift=3.2cm] (Theorem4Conditional)
  {\textbf{Theorem 4 Wrappers} \\ Closed Problem 11 odd/even large-misestimation};
...
\node[dag_unformalized, below=of VExist] (Theorem4Full)
  {\textbf{Theorem 4 (App. E)} \\ Open: source-level packaging of $v$, reduction, and baseline};
