...
\node[dag_conditional, below=1.7cm of NoFairness, xshift=3.2cm] (Theorem4Conditional)
  {\textbf{Theorem 4 Fairness Wrappers} \\ Source cold-user policy; estimated lift; needs Problem 11 LP-selection};
...
\node[dag_unformalized, below=of VExist] (Theorem4Full)
  {\textbf{Theorem 4 (App. E)} \\ Open: LP-selection/unique optimum + source no-fairness wrapper};
