...
| Theorem 6.1, set-packing, independent-set, and clique allocation reductions | `PaperInterface.theorem6_1_weighted_set_packing_reduction`, `PaperInterface.theorem6_1_optimal_solver_reduction`, `PaperInterface.theorem6_1_approximation_preserving_reduction`, `PaperInterface.theorem6_1_approximation_solver_reduction`, `PaperInterface.theorem6_1_decision_problem_encoding_correct`, `PaperInterface.theorem6_1_decision_problem_reduction`, `PaperInterface.theorem6_1_polynomial_time_decision_problem_reduction`, `PaperInterface.theorem6_1_set_packing_hardness_transfers_to_single_minded`, `PaperInterface.theorem6_1_clique_decision_complement_independent_set_reduction`, `PaperInterface.theorem6_1_independent_set_decision_set_packing_reduction`, `PaperInterface.theorem6_1_clique_decision_set_packing_reduction`, `PaperInterface.theorem6_1_clique_decision_single_minded_welfare_reduction`, `PaperInterface.theorem6_1_clique_hardness_transfers_to_single_minded`, `PaperInterface.theorem6_1_graph_independent_set_feasibility_reduction`, `PaperInterface.theorem6_1_independent_set_set_packing_reduction`, `PaperInterface.theorem6_1_independent_set_allocation_reduction`, `PaperInterface.theorem6_1_clique_complement_independent_set_reduction`, `PaperInterface.theorem6_1_clique_complement_set_packing_reduction`, `PaperInterface.theorem6_1_clique_complement_allocation_reduction` | formalized | `LOS02CombinatorialAuctions/PaperInterface.lean` | None; the clique-complement, graph-edge incidence, weighted set-packing, threshold-decision, reduction-closed hardness-transfer, exact solver, and approximation-preserving reductions used by the source proof are represented |
| Theorem 6.1, NP-hardness and NP=ZPP complexity consequences | `PaperInterface.theorem6_1_external_optimal_solver_complexity_consequence`, `PaperInterface.theorem6_1_external_approximation_solver_complexity_consequence`, `PaperInterface.theorem6_1_external_optimal_solver_np_eq_zpp`, `PaperInterface.theorem6_1_external_approximation_solver_np_eq_zpp` | conditional | `LOS02CombinatorialAuctions/PaperInterface.lean` | The Karp/Hastad set-packing hardness facts and polynomial-time preservation are supplied externally; Lean now names the abstract `NP = ZPP` consequence through `EconCSLib.Complexity.ComplexityClassModel`, while machine-level class semantics remain outside the current library |
| Complexity-class note after Theorem 6.1 | `PaperInterface.complexity_note_p_eq_np_implies_np_eq_zpp`, `PaperInterface.complexity_note_np_eq_zpp_implies_randomized_collapse` | conditional | `LOS02CombinatorialAuctions/PaperInterface.lean` | The class relationships are fields of the abstract `RandomizedComplexityClassModel`; Lean proves the note's collapse implications without claiming machine-level semantics |
| Definition 7.1, average amount per good | `PaperInterface.averageAmountPerGood`, `PaperInterface.averageAmountPerGood_le_of_subset_value_le`, `PaperInterface.sqrtAmountNorm`, `PaperInterface.averageOrderOf`, `PaperInterface.averageValueUpdateWindow`, `PaperInterface.averageValueUpdateWindow_membership_iff_mechanism_of_split` | formalized | `LOS02CombinatorialAuctions/PaperInterface.lean` | None; also exposes the square-root norm used in Theorem 7.2 and the concrete deterministic average-descending bidder order, including duplicate-freeness, membership, average-descending sortedness, stability after erasing a value-updated bidder, the ordered-insertion suffix window, and the local-to-full mechanism membership equivalence |
| Greedy allocation scheme | `PaperInterface.greedyAcceptedFromOrder`, `PaperInterface.greedyAllocationFromOrder`, `PaperInterface.averageGreedyAcceptedSet`, `PaperInterface.averageGreedyAllocation`, `PaperInterface.averageOrder_greedy_allocation_scheme`, `PaperInterface.greedy_accepted_pairwise_disjoint`, `PaperInterface.averageGreedyAcceptedSet_pairwise_disjoint`, `PaperInterface.greedy_allocation_feasible`, `PaperInterface.averageGreedyAllocation_feasible` | formalized | `LOS02CombinatorialAuctions/PaperInterface.lean` | None; the explicit-order greedy fold and the concrete average-order instantiation are represented; accepted bids are pairwise disjoint and the induced allocation is feasible when accepted desired bundles lie in the goods set |
| Theorem 7.2, greedy allocation approximation | `PaperInterface.theorem7_2_rejected_bid_has_preceding_sqrt_blocker`, `PaperInterface.theorem7_2_order_blocking_certificate_of_disjoint`, `PaperInterface.theorem7_2_blocking_certificate_normsq_bound`, `PaperInterface.theorem7_2_sqrt_norm_approx_of_sorted_order`, `PaperInterface.theorem7_2_sqrt_norm_approx_of_sorted_order_disjoint`, `PaperInterface.theorem7_2_common_bid_removal_bridge` | formalized | `LOS02CombinatorialAuctions/PaperInterface.lean` | None; proves the `sqrt(k)` approximation for a sorted explicit greedy order, derives the source proof's blocker/counting and reduced disjoint instance steps, and lifts the bound back by the common-bid add-back bridge |
...
| Theorem 9.6, Exactness/Monotonicity/Participation/Critical imply truthfulness | `PaperInterface.theorem9_6_single_minded_truthful_of_infinity_axioms`, `PaperInterface.theorem9_6_single_minded_truthful_of_nonnegative_infinity_axioms` | formalized | `LOS02CombinatorialAuctions/PaperInterface.lean` | None; accepted-set exactness, source-shaped monotonicity/participation, and finite-or-infinite critical-value certificates imply truthfulness for nonempty nonnegative single-minded bid profiles; the domain-aware certificate only requires critical clauses on that source domain |
| Definition 10.1, greedy payment scheme | `PaperInterface.greedyNextDeniedFromOrder`, `PaperInterface.greedyPaymentFromOrder`, `PaperInterface.averageGreedyPayment`, `PaperInterface.greedy_payment_from_order_eq_zero_of_denied`, `PaperInterface.greedy_payment_from_order_eq_zero_of_no_next`, `PaperInterface.greedy_payment_from_order_eq_of_next`, `PaperInterface.averageGreedyPayment_eq_zero_of_denied`, `PaperInterface.averageGreedyPayment_eq_zero_of_no_next`, `PaperInterface.averageGreedyPayment_eq_of_next`, `PaperInterface.greedy_value_update_local_critical_window_of_sorted_erase`, `PaperInterface.averageValueUpdateWindow_sourceSortedEraseCriticalWindowOfSourceSplit`, `PaperInterface.averageSourceCriticalBranchWindowsOfAccepted` | formalized | `LOS02CombinatorialAuctions/PaperInterface.lean` | None; the full-order `n(j)` search, the concrete average-order payment rule, denied/no-next/next payment cases, suffix-window critical branches, and accepted-bid source branch windows are represented |
| Theorem 10.2, greedy allocation plus payments truthful for single-minded bidders | `PaperInterface.theorem10_2_averageGreedy_truthful`, `PaperInterface.theorem10_2_average_order_update_moves_earlier`, `PaperInterface.averageGreedyAcceptedMechanism_nonnegativeMonotonicity`, `PaperInterface.theorem10_2_greedy_truthful_of_infinity_certificate`, `PaperInterface.theorem10_2_greedy_truthful_of_nonnegative_infinity_certificate`, `PaperInterface.theorem10_2_averageGreedy_truthful_of_monotonicity`, `PaperInterface.averageGreedyNonnegativeCriticalSourceBranchData`, `PaperInterface.averageGreedyNonnegativeCriticalCertificate`, `PaperInterface.averageGreedy_acceptedPaymentCriticalOfAccepted`, `PaperInterface.greedy_accepted_mechanism_participation`, `PaperInterface.greedy_accepted_mechanism_monotonicity_of_order_moves_earlier`, `PaperInterface.theorem10_2_greedy_threshold_truthful_of_full_order_payment_certificate` | formalized | `LOS02CombinatorialAuctions/PaperInterface.lean` | None; concrete average-order greedy accepted-set/payment truthfulness is proved on the source nonempty nonnegative single-minded domain; generic certificate forms remain exposed |
