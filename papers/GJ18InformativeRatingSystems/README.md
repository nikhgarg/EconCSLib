...
| Theorem 1 finite-chain real-rate floor endpoint | `theorem1_finite_chain_uniform_floor_objective_oneSub_exact_min_adjacent_rate_from_joint_floor_rating_law` | conditional | `PaperInterface.lean` | Compatibility route for the older all-real statement; the canonical support-safe finite-rate theorem is closed by the source-facing endpoint above. |
