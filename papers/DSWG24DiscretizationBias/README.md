...
lemmas live in `EconCSLib/Decision/Argmax.lean`.

## Theorem Status

| Paper item | Lean declaration | Status | File | Remaining assumptions |
|---|---|---|---|---|
| Theorem 2(i), finite deterministic optimizer existence | `paper_theorem2i_finite_objective_optimizer_exists` | formalized finite objective-existence core | `DSWG24DiscretizationBias/MainTheorems.lean` | finite dataset/action model; paper objective supplied as a real-valued rule functional |
| Theorem 2(ii), argmax is accuracy-maximizing for Bayes-optimal scores | `paper_theorem2ii_argmax_accuracy_maximizing` | formalized finite deterministic core | `DSWG24DiscretizationBias/MainTheorems.lean` | deterministic finite dataset/label model; posterior scores supplied directly |
