...
| Theorem 4, appendix structural theorem subsuming Theorem 2 | `theorem4NonsurgeShape`, `theorem4SurgeShape`, `theorem4NonsurgeShape_cases_of_not_acceptsAll`, `theorem4SurgeShape_cases_of_not_acceptsAll`, `theorem4NonsurgeAllowedLemma5Shape`, `theorem4SurgeAllowedLemma5Shape`, `Theorem4MeasurableEndpointCurrentBoundsExactOneThresholdNonAcceptAllSelectionUnlessCertificate`, `Theorem4MeasurableEndpointCurrentBoundsTheorem3FixedTransferRegularExactOneThresholdNonAcceptAllSelectionUnlessCertificate`, `paper_theorem4_measurable_accept_all_unique_optimal_of_endpoint_current_bounds_exact_one_threshold_non_accept_all_selection_unless`, `paper_theorem4_measurable_accept_all_unique_optimal_of_endpoint_theorem3_fixed_transfer_regular_exact_one_threshold_non_accept_all_selection_unless`, `paper_theorem4_measurable_accept_all_unique_optimal_of_extended_one_threshold_branch_surge_cross_by_policy_form_fixed_transfer_source`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_feasible_ae_forms_and_representative_rejected_mass_improvements_from_exists`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_fixed_response_policy_forms_and_representative_rejected_mass_improvements_from_exists`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_gn21_bracket_source_data_and_representative_rejected_mass_improvements_from_exists`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_middle_reroute_ae_policy_form_source_existence`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_middle_reroute_light_ae_eq_source_existence`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_light_ae_feasible_canonical_endpoint`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_fixed_response_policy_form_by_policy_form_middle_cutoff_reroute_source_existence`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_fixed_response_policy_form_surge_cross_by_policy_form_middle_cutoff_reroute_source_existence`, `PaperInterface.theorem4_acceptAll_unique_exact_one_threshold_non_accept_all_endpoint`, `PaperInterface.theorem4_acceptAll_unique_fixed_transfer_exact_one_threshold_non_accept_all_endpoint`, `PaperInterface.theorem4_acceptAll_unique_extended_one_threshold_surge_cross_source`, `PaperInterface.theorem4_acceptAll_ae_unique_feasible_ae_representative_rejected_mass`, `PaperInterface.theorem4_acceptAll_ae_unique_fixed_response_representative_rejected_mass`, `PaperInterface.theorem4_acceptAll_ae_unique_gn21_bracket_representative_rejected_mass`, `PaperInterface.theorem4_acceptAll_ae_unique_middle_reroute_policy_form_source_existence`, `PaperInterface.theorem4_acceptAll_ae_unique_middle_reroute_light_eq_source_existence`, `PaperInterface.theorem4_acceptAll_ae_unique_light_ae_feasible_canonical_endpoint`, `PaperInterface.theorem4_acceptAll_ae_unique_fixed_response_by_policy_form_middle_cutoff`, `PaperInterface.theorem4_acceptAll_ae_unique_fixed_response_surge_cross_middle_cutoff` | conditional | `MainTheorems.lean`, `Theorem3Frontier.lean`, `Theorem4Frontier.lean`, `PaperInterface.lean` | The structural shape routing from Lemma 5 policy forms to Theorem 4 non-surge/surge alternatives is closed. The frontier module packages exact one-threshold non-accept-all endpoint selection, fixed-transfer endpoint data, and the extended aggregate-cross source package into the literal accept-all unique measurable optimum conclusion. It now also exposes the a.e. representative route that derives accept-all optimality from existence plus positive-rejected-mass strict endpoint moves, including the raw GN21 bracket source boundary, the LightAE feasible-canonical endpoint, and the fixed-price middle-reroute and by-policy-form middle-cutoff source packages used by the Theorem 3 route. The remaining analytic work is to derive either the exact/non-accept-all one-threshold source-selection facts, or the a.e. representative positive-rejected-mass endpoint moves, from the paper primitives for arbitrary measurable optima. |
