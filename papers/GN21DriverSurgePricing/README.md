...
- Theorem 1 now has canonical strict, complete, and boundary threshold sets,
  ...
  rate, and compact upper-semicontinuity Step 3 reductions that leave only the
  source tail/gap existence facts as analytic obligations.
...
the high-reward no-mass-gap alternative, plus the two-state renewal
