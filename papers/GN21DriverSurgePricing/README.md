...
- The zero-mass boundary is now explicit.  `DomainBridge.lean` proves the
  ...
  Thus source-faithful reward-rate routes should stay on the
  positive-mass/nondegenerate domain, or the optional full-domain theorem must
  use an explicit zero-mass dominance condition or a different
  extended-real/nondegenerate reward interface.  The shortest compiled
...
| Theorem 4 accept-all uniqueness corollaries for Theorem 3 | `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_positive_response_acceptAll_candidates`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_structured_current_bounds_source_positive_response`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_structured_current_bounds_optimal_source_positive_response`, `paper_theorem4_measurable_accept_all_unique_optimal_of_endpoint_current_bounds_exact_one_threshold_non_accept_all_selection_unless`, `paper_theorem4_measurable_accept_all_unique_optimal_of_endpoint_theorem3_fixed_transfer_regular_exact_one_threshold_non_accept_all_selection_unless`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_feasible_ae_forms_and_representative_rejected_mass_improvements_from_exists`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_fixed_response_policy_form_by_policy_form_middle_cutoff_reroute_source_existence`, `paper_theorem4_measurable_accept_all_ae_unique_optimal_of_fixed_response_policy_form_surge_cross_by_policy_form_middle_cutoff_reroute_source_existence`, `PaperInterface.theorem4_acceptAll_ae_unique_of_positive_response_candidates`, `PaperInterface.theorem4_acceptAll_ae_unique_of_current_bounds_source`, `PaperInterface.theorem4_acceptAll_ae_unique_of_optimal_current_bounds`, `PaperInterface.theorem4_acceptAll_unique_exact_one_threshold_non_accept_all_endpoint`, `PaperInterface.theorem4_acceptAll_ae_unique_feasible_ae_representative_rejected_mass`, `PaperInterface.theorem4_acceptAll_ae_unique_fixed_response_by_policy_form_middle_cutoff`, `PaperInterface.theorem4_acceptAll_ae_unique_fixed_response_surge_cross_middle_cutoff`, `PaperInterface.theorem4_acceptAll_ae_unique_fixed_response_surge_cutoff_middle_cutoff` | conditional | `MainTheorems.lean`, `Theorem4Frontier.lean`, `Theorem3Frontier.lean`, `PaperInterface.lean` | Lean proves the positive-response/current-bounds accept-all a.e. uniqueness conclusion used by the closed positive-mass Theorem 3 route. The remaining conditional endpoints are the stronger exact/non-accept-all one-threshold source-selection route and the broader a.e. representative positive-rejected-mass route for arbitrary measurable optima. |
| Theorem 2, multiplicative pricing not IC and optimal policy shapes | `paper_theorem2_multiplicative_measured_not_ic_explicit_atomic`, `theorem2AtomicMu`, `theorem2AtomicAggregate_profitable`, `theorem2AtomicQ_bounds`, `MultiplicativeMeasuredAggregateNotICCertificate`, `paper_theorem2_multiplicative_measured_not_ic_of_aggregate_witness`, `paper_theorem2_multiplicative_extended_measurable_policy_shape_of_shape_derivation`, `paper_theorem2_multiplicative_measurable_policy_shape_ae_of_feasible_ae_policy_forms`, `paper_theorem2_one_threshold_measurable_policy_shape_ae_of_gn21_bracket_source_data`, `PaperInterface.theorem2_multiplicative_policy_shape_ae_of_feasible_ae_policy_forms`, `PaperInterface.theorem2_one_threshold_policy_shape_ae_of_gn21_bracket_source_data`, `PaperInterface.theorem2_multiplicative_measured_not_ic_explicit_atomic`, `PaperInterface.theorem2_multiplicative_measured_not_ic_witness`, `PaperInterface.theorem2_multiplicative_measured_not_ic_aggregate_witness` | formalized with caveat | `MainTheorems.lean`, `Lemma5Frontier.lean`, `Theorem2ExplicitInstance.lean`, `PaperInterface.lean` | Lean proves the measured multiplicative non-IC branch for an explicit atomic Section 5-style instance: state 0 has a Dirac trip at `1/2`, state 1 mixes Dirac trips at `1` and `6`, arrivals are `1` and `50`, switch rates are `1/4` and `4`, and multiplicative rates are `4` and `40`; the profitable deviation is accept-all in state 0 and reject-short in state 1. The proof reduces `Q,T,W` primitives to weighted-Dirac integrals, bounds the CTMC switch probabilities, proves the strict aggregate reward improvement, and feeds the existing measured aggregate certificate into dynamic non-IC. The a.e. optimal-policy shape clause is closed at the Theorem 4/feasible Lemma 5 handoff, with raw GN21 bracket data giving the one-threshold CTMC source surface; this shape handoff is separate from the numeric atomic non-IC witness. |
| Theorem 3, structured IC pricing | `paper_theorem3_measured_structured_positive_mass_measurable_ic_ae_unique_prices_of_source_assumptions`, `theorem3MeasuredStructuredPositiveMassMeasurableICAEUniqueConclusion`, `PaperInterface.theorem3_positive_mass_source`, `PaperInterface.theorem3_small_surge_mass_affine_fixed_lower_cross_final_sign_no_rmax_normalized`, `theorem3MeasuredStructuredMeasurableICAEUniqueConclusion_of_positiveMass_ae_unique_and_zeroMassStrictDominance`, `PaperInterface.theorem3_zero_mass_dominance_of_acceptAll_dominates_zero_mass`, `PaperInterface.theorem3_zero_mass_totalization_obstruction` | formalized with caveat | `DomainBridge.lean`, `MainTheorems.lean`, `Theorem3Frontier.lean`, `ProofInterface.lean`, `PaperInterface.lean` | Lean closes the denominator-valid source theorem on the positive-mass measurable domain. It constructs the structured CTMC prices, proves positive-mass measurable IC, proves surge accept-all a.e. from Lemma 9, transports the measured reward through the a.e. surge replacement, and proves non-surge accept-all a.e. from Lemma 10 with surge fixed at exact accept-all. The stronger full feasible-measurable lift is available only with an explicit `DynamicZeroMassStrictDominanceCertificate` or a revised non-totalized reward interface, because the paper reward-rate formulas divide by accepted trip mass; the compiled accept-all helper reduces that certificate to accept-all positive mass plus strict dominance over feasible zero-mass policies. Lean also proves the left-empty/right-accept-all totalization obstruction for the current real-valued reward model. |
