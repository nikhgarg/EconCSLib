...
- Theorem 1 now has canonical strict, complete, and boundary threshold sets,
  ...
  dominated-convergence compact continuity is closed under zero
  threshold-boundary mass, while the general atom-at-threshold source case
  remains as the final analytic obligation.
...
| Theorem 1, single-state threshold best response | `strictThresholdRatePolicy`, `partialThresholdRatePolicy`, `thresholdRatePolicy`, `strictThresholdPolicy`, `completeThresholdPolicy`, `thresholdBoundaryPolicy`, `singleStateMeasurableOptimal`, `SingleStateMeasurableThresholdCertificate`, `thresholdRatePolicy_multiplicative_acceptAll`, `paper_theorem1_multiplicative_threshold_best_response_measurable`, `paper_theorem1_multiplicative_threshold_best_response_measurable_of_standard_measure`, `strictThresholdPolicy_subset_of_partialThresholdRatePolicy`, `partialThresholdRatePolicy_subset_completeThresholdPolicy`, `partialThresholdRatePolicy_remove_boundary_eq_strict`, `partialThresholdRatePolicy_add_boundary_eq_complete`, `measurableSet_strictThresholdPolicy`, `measurableSet_completeThresholdPolicy`, `measurableSet_thresholdBoundaryPolicy`, `continuousAt_strictThresholdPolicy_indicator_of_not_boundary`, `continuousAt_completeThresholdPolicy_indicator_of_not_boundary`, `continuousAt_setIntegral_strictThresholdPolicy_of_boundary_measure_zero`, `continuousAt_setIntegral_completeThresholdPolicy_of_boundary_measure_zero`, `continuousAt_theorem1_cutoff_objective_of_boundary_measure_zero`, `continuousOn_theorem1_cutoff_objective_of_boundary_measure_zero`, `antitone_strictThresholdPolicy`, `antitone_completeThresholdPolicy`, `iInter_strictThresholdPolicy_eq_empty`, `iInter_completeThresholdPolicy_eq_empty`, `singleStateTripPayment_strictThresholdPolicy_tendsto_zero`, `singleStateTripTime_strictThresholdPolicy_tendsto_zero`, `singleStateTripPayment_completeThresholdPolicy_tendsto_zero`, `singleStateTripTime_completeThresholdPolicy_tendsto_zero`, `measurable_affinePricing_rate`, `measurableSet_strictThresholdPolicy_affinePricing`, `measurableSet_completeThresholdPolicy_affinePricing`, `measurableSet_thresholdBoundaryPolicy_affinePricing`, `onTripRateEquals_thresholdBoundaryPolicy`, `singleStateTripPayment_eq_rate_mul_time_of_onTripRateEquals`, `singleStateRenewalReward_diff_eq_self_of_zero_rate_component`, `singleStateRenewalReward_union_eq_self_of_zero_rate_component`, `singleStateRenewalReward_tendsto_zero_of_payment_time_tendsto_zero`, `singleStateAverageTripRate`, `paper_theorem1_step1_same_time_more_payment_improves_reward`, `paper_theorem1_step1_equal_utilization_swap_improves_reward`, `paper_theorem1_policy_le_complete_threshold_at_own_reward`, `paper_theorem1_add_positive_time_set_if_average_above_current`, `paper_theorem1_remove_positive_time_set_if_average_below_current`, `paper_theorem1_add_positive_time_set_if_average_strictly_above_current`, `paper_theorem1_remove_positive_time_set_if_average_strictly_below_current`, `paper_theorem1_no_addable_positive_time_average_above_current_of_optimal`, `paper_theorem1_no_removable_positive_time_average_below_current_of_optimal`, `paper_theorem1_add_set_if_pointwise_rate_above_current`, `paper_theorem1_remove_set_if_pointwise_rate_below_current`, `paper_theorem1_step2_add_boundary_set_if_threshold_ge_current`, `paper_theorem1_step2_remove_boundary_set_if_threshold_le_current`, `paper_theorem1_step2_partial_threshold_dominated_by_strict_or_complete`, `paper_theorem1_complete_threshold_ge_strict_threshold_of_cutoff_ge_strict_reward`, `paper_theorem1_strict_threshold_reward_lt_higher_strict_threshold_of_positive_band`, `paper_theorem1_strict_threshold_reward_eq_complete_threshold_of_gap_measure_zero`, `paper_theorem1_high_reward_band_or_gap`, `paper_theorem1_step3_dominated_of_gap_resolution_at_max`, `paper_theorem1_complete_ge_strict_at_max_of_band_resolution`, `paper_theorem1_cutoff_maximizer_of_compact_upperSemicontinuity`, `paper_theorem1_left_tail_bound_of_nonnegative_rate`, `paper_theorem1_exists_right_tail_bound_of_tendsto_zero`, `paper_theorem1_objective_zero_pos_of_acceptAll_payment_pos`, `paper_theorem1_objective_tendsto_zero_of_threshold_rewards_tendsto_zero`, `paper_theorem1_objective_tendsto_zero_of_threshold_payment_time_tails`, `paper_theorem1_step3_strict_complete_dominated_of_compact_upperSemicontinuity_band_resolution`, `paper_theorem1_step3_strict_complete_dominated_of_compact_upperSemicontinuity_band_or_gap_resolution`, `paper_theorem1_complete_threshold_optimal_of_step_certificates`, `paper_theorem1_complete_threshold_optimal_of_step1_step3_renewal_reward`, `SingleStateThresholdCertificate`, `paper_theorem1_threshold_certificate_of_step_certificates`, `paper_theorem1_threshold_certificate_of_step1_step3_renewal_reward`, `paper_theorem1_measurable_threshold_certificate_of_complete_maximizer_renewal_reward`, `paper_theorem1_single_state_threshold_best_response_measurable_of_complete_maximizer`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_continuity`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_upperSemicontinuity_band_or_gap`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_upperSemicontinuity_tail_bounds`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_upperSemicontinuity_right_tail`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_upperSemicontinuity_limit_tail`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_upperSemicontinuity_limit_tail_acceptAll_positive`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_upperSemicontinuity_integral_tails`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_upperSemicontinuity`, `paper_theorem1_single_state_threshold_best_response_measurable_of_compact_continuous_objective`, `paper_theorem1_single_state_threshold_best_response_measurable_of_no_boundary_mass`, `paper_theorem1_single_state_threshold_best_response_of_certificate` | partially formalized | `MainTheorems.lean`, `EconCSLib/Foundations/Probability/RenewalReward.lean` | Lean proves canonical measurable threshold sets, affine-pricing threshold measurability, the multiplicative-pricing special case with accept-all as the complete threshold at rate `m`, continuous measured Step 1 equal-utilization replacement algebra, the stronger measurable Step 1 replacement by the complete threshold at the policy's own reward rate, the full Step 2 dominance theorem from any measurable feasible partial threshold to either the strict or complete threshold, including zero boundary-time cases, the general marginal add/remove renewal steps including zero-time-compatible pointwise variants and strict average-rate variants, compact upper-semicontinuity maximizer reductions for Step 3, the low-reward boundary-addition margin case, the high-reward positive-band contradiction case, the zero-measure gap replacement case, the midpoint high-reward band/gap dichotomy, the negative-cutoff left-tail bound from nonnegative rates, the high-cutoff right-tail bound from antitone threshold-set integral convergence, dominated-convergence continuity of threshold integrals at zero-boundary-mass cutoffs, the generic Step 1/2/3 assembly theorem, and measurable best-response endpoints from a complete-threshold maximizer, compact-continuity maximizer, compact strict/complete objective plus band-or-gap resolution, compact upper-semicontinuity, compact continuity of the full cutoff objective, or the no-boundary-mass source-regularity condition. The remaining fully general source-specific Step 3 work is the atom-at-threshold compact upper-semicontinuity argument when some cutoff boundary has positive mass. |
...
| Lemma 4, single-state optimal interval form | `agreesAwayFromThresholdBoundary`, `agreesAwayFromThresholdBoundary_completeThresholdPolicy_of_partial`, `SingleStateUniqueThresholdCertificate`, `paper_lemma4_reward_cutoff_complete_threshold_optimal`, `paper_lemma4_rejected_strict_threshold_time_zero_of_optimal_reward`, `paper_lemma4_accepted_below_complete_threshold_time_zero_of_optimal_reward`, `paper_lemma4_single_state_threshold_time_zero_uniqueness_of_complete_threshold_optimal`, `paper_lemma4_unique_threshold_certificate_of_complete_threshold_optimal`, `paper_lemma4_single_state_unique_threshold_of_complete_threshold_optimal`, `paper_lemma4_unique_threshold_certificate_of_complete_threshold_optimal_and_partial_optima`, `paper_lemma4_single_state_unique_threshold_of_complete_threshold_optimal_and_partial_optima`, `paper_lemma4_single_state_unique_threshold_of_certificate` | conditional | `MainTheorems.lean` | Lean now proves the source Lemma 4 argument after a complete-threshold optimum is supplied: moving the cutoff to the realized reward rate gives another optimal complete-threshold policy with reward exactly equal to its cutoff, and every feasible measurable optimal policy can differ from that reward-cutoff threshold only on zero-trip-time off-threshold sets. The older exact-set certificate remains available under the stronger partial-threshold-at-reward-cutoff hypothesis. The remaining dependency is Theorem 1's compactness/selection proof that supplies a complete-threshold optimum for every pricing function. |
...
high-reward band/gap split are now compiled, leaving compact
upper-semicontinuity of the cutoff objective as the source analytic seam in
the atom-at-threshold case.  The zero-boundary-mass regularity route is
compiled end to end.
...
Then finish Theorem 1's compact upper-semicontinuity proof for the
strict/complete cutoff objective in the atom-at-threshold case, plus the
two-state renewal law-of-large-numbers bridge.
