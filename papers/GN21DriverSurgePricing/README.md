...
- Theorem 1 now has canonical strict, complete, and boundary threshold sets,
  ...
  rate, and compact upper-semicontinuity Step 3 band/gap reductions that leave
  only the source tail and high-reward dichotomy facts as analytic obligations.
...
threshold-set infrastructure. Lemma 1/Lemma 3 deterministic algebra is
...
Then finish Theorem 1's source tail compactness/upper-semicontinuity facts and
the high-reward band-or-gap dichotomy from the paper's continuity assumptions,
plus the two-state renewal law-of-large-numbers bridge.
