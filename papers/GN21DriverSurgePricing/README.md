...
the Step 1 equal-utilization swap, full Step 2 partial-threshold dominance,
the multiplicative-pricing threshold best-response special case, a reduced
Step 1/3 assembly theorem, and canonical measurable threshold-set
...
Theorem 1 now has a
constructor from reduced Step 1/3 obligations to the threshold certificate interface,
