...
- Theorem 4 now has compact paper-facing structural endpoints for the
  ...
  it consumes the by-policy-form middle-reroute fixed-transfer source package
  already used by Theorem 3, then proves the paper's a.e. accept-all
  uniqueness conclusion directly for that structured price.  The remaining
