...
- Appendix D now exposes the derivative-sign kernel, the polynomial-to-response
  ...
  derivative-kernel support.  Lemma 10 additionally
...
response. Theorem 4 now has the pure routing from Lemma 5 policy
