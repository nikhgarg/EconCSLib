...
- Theorem 1 now has canonical strict, complete, and boundary threshold sets,
  ...
  only compact upper-semicontinuity of the strict/complete cutoff objective
  remains as a source analytic obligation.
...
upper-semicontinuity of the cutoff objective as the source analytic seam.
...
assumptions, plus the two-state renewal law-of-large-numbers bridge.
