...
| Lemma 4, single-state optimal interval form | `agreesAwayFromThresholdBoundary`, `agreesAwayFromThresholdBoundary_completeThresholdPolicy_of_partial`, `SingleStateUniqueThresholdCertificate`, `paper_lemma4_reward_cutoff_complete_threshold_optimal`, `paper_lemma4_unique_threshold_certificate_of_complete_threshold_optimal`, `paper_lemma4_single_state_unique_threshold_of_complete_threshold_optimal`, `paper_lemma4_unique_threshold_certificate_of_complete_threshold_optimal_and_partial_optima`, `paper_lemma4_single_state_unique_threshold_of_complete_threshold_optimal_and_partial_optima`, `paper_lemma4_single_state_unique_threshold_of_certificate` | conditional | `MainTheorems.lean` | Lean now proves the first source step of Lemma 4: from any optimal complete-threshold policy, moving the cutoff to the realized reward rate gives another optimal complete-threshold policy with reward exactly equal to its cutoff. It also proves exact agreement away from the cutoff boundary for any optimal policy that is a partial threshold at that reward cutoff. The remaining source obligation is deriving that partial-threshold-at-reward-cutoff fact for all optimal policies, with the paper's measure-zero caveat made explicit if exact set equality is too strong. |
