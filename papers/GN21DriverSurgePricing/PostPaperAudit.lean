...
abbrev audit_section2_single_state_ic := @PaperInterface.definition_single_state_ic

/-- Audit endpoint for Section 2.2 dynamic incentive compatibility. -/
abbrev audit_section2_dynamic_ic := @PaperInterface.definition_dynamic_ic

/-- Audit endpoint for Section 2.2 threshold-policy notation. -/
abbrev audit_section2_threshold_policy := @PaperInterface.definition_threshold_policy

/-- Audit endpoint for the IID renewal-reward bridge behind Section 2.2. -/
abbrev audit_section2_single_state_renewal_reward_iid_bridge := @PaperInterface.section2_single_state_renewal_reward_iid_bridge

/-- Audit endpoint for the denominator-valid defined dynamic reward surface. -/
abbrev audit_section2_dynamic_defined_reward := @PaperInterface.definition_dynamic_defined_reward

/-! ## Single-state source results -/

/-- Audit endpoint for Theorem 1: single-state threshold best response. -/
abbrev audit_theorem1_single_state_threshold_best_response := @PaperInterface.theorem1_single_state_threshold_best_response

/-- Audit endpoint for Proposition 3.1: affine single-state measurable IC. -/
abbrev audit_proposition3_1_affine_single_state_ic := @PaperInterface.proposition3_1_affine_single_state_ic

/-- Audit endpoint for Lemma 4: threshold optimizer uniqueness up to null sets. -/
abbrev audit_lemma4_single_state_threshold_uniqueness := @PaperInterface.lemma4_single_state_threshold_uniqueness

/-! ## CTMC reward and time-fraction lemmas -/

/-- Audit endpoint for Lemma 1: measured dynamic reward decomposition. -/
abbrev audit_lemma1_measured_dynamic_reward_decomposition := @PaperInterface.lemma1_measured_dynamic_reward_decomposition

/-- Audit endpoint for Lemma 2: CTMC switch-probability formula. -/
abbrev audit_lemma2_switch_probability_formula := @PaperInterface.lemma2_switch_probability_formula

/-- Audit endpoint for Remark 1: switch probability per time is strictly antitone. -/
abbrev audit_remark1_switch_probability_per_time_strictAntiOn := @PaperInterface.remark1_switch_probability_per_time_strictAntiOn

/-- Audit endpoint for Remark 3: switch probability per time tends to the switch rate. -/
abbrev audit_remark3_switch_probability_per_time_tendsto_at_zero := @PaperInterface.remark3_switch_probability_per_time_tendsto_at_zero

/-- Audit endpoint for Remark 4: `lambda * t - q(t)` is nonnegative. -/
abbrev audit_remark4_switch_time_minus_switch_probability_nonneg := @PaperInterface.remark4_switch_time_minus_switch_probability_nonneg

/-- Audit endpoint for Lemma 3: measured state time-fraction formula. -/
abbrev audit_lemma3_measured_time_fraction_formula := @PaperInterface.lemma3_measured_time_fraction_formula
...
abbrev audit_lemma7_affine_positive_additive_response_quasi_convex := @PaperInterface.lemma7_affine_positive_additive_response_quasi_convex

/-- Audit endpoint for Lemma 8: negative-additive response quasi-concavity. -/
abbrev audit_lemma8_affine_negative_additive_response_quasi_concave := @PaperInterface.lemma8_affine_negative_additive_response_quasi_concave

/-- Audit endpoint for Lemma 9: surge derivative positivity. -/
abbrev audit_lemma9_surge_derivative_positive_of_acceptAll_bounds := @PaperInterface.lemma9_surge_derivative_positive_of_acceptAll_bounds

/-- Audit endpoint for Lemma 10: non-surge derivative positivity. -/
abbrev audit_lemma10_nonsurge_derivative_positive_of_acceptAll_bounds := @PaperInterface.lemma10_nonsurge_derivative_positive_of_acceptAll_bounds
...
abbrev audit_theorem3_feasibility_threshold := @PaperInterface.theorem3_feasibility_threshold

/-- Audit endpoint for Theorem 3: positive-mass source-domain IC and a.e. uniqueness. -/
abbrev audit_theorem3_positive_mass_source := @PaperInterface.theorem3_positive_mass_source
...
-/
abbrev audit_theorem3_positive_response_source := @PaperInterface.theorem3_positive_response
...
certificate.
-/
abbrev audit_theorem3_positive_fixed_response_source := @PaperInterface.theorem3_positive_fixed_response_normalized

/-- Audit endpoint for Theorem 3: positive-mass IC as a defined-reward statement. -/
abbrev audit_theorem3_defined_reward_ic_of_positive_mass := @PaperInterface.theorem3_defined_reward_ic_of_positive_mass
...
abbrev audit_theorem3_source_with_zero_mass_dominance := @PaperInterface.theorem3_source_with_zero_mass_dominance

/-- Audit endpoint for the zero-mass totalization obstruction in the current reward model. -/
abbrev audit_theorem3_zero_mass_totalization_obstruction := @PaperInterface.theorem3_zero_mass_totalization_obstruction
