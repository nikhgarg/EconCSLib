...
theorem toConsumptionModel_has_nonnegative_marginals {T : ℕ}
  ...
  intro t q
  simpa [ConsumptionModel.HasNonnegativeMarginals, DecisionCore.Allocation.HasNonnegativeMarginals,
    DecisionCore.Allocation.marginal, toConsumptionModel] using
...
theorem toConsumptionModel_has_diminishing_returns {T : ℕ}
  ...
  intro t q
  simpa [ConsumptionModel.HasDiminishingReturns, DecisionCore.Allocation.HasDiminishingReturns,
    DecisionCore.Allocation.marginal, toConsumptionModel] using
