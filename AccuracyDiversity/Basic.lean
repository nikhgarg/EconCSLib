...
abbrev CountAllocation (T : ℕ) := DecisionCore.Allocation (ItemType T)
...
@[simp] theorem objective_eq_allocation_objective {T : ℕ}
    ...
    M.objective a = DecisionCore.Allocation.objective a M.likelihood M.valueOfCount := rfl
